...
function SearchCodeInit(code_a, code_b, code_c, code_d) {
	...
	if(typeof(document.forms[0].code_a)!="object") return;

	var d = new Option("〓〓 1차 카테고리 〓〓");
	document.forms[0].code_a.options[0] = d;
	document.forms[0].code_a.options[0].value = "";
	for(var i=0;i<all_list1.length;i++) {
		...
		document.forms[0].code_a.options[i+1] = d;
		document.forms[0].code_a.options[i+1].value = all_list1[i].CodeA;

		if (all_list1[i].CodeA == code_a) {
			document.forms[0].code_a.selectedIndex = i+1;
			if(typeof(document.forms[0].code_b)!="object") return;
			try {
				if(all_list1[i].CodeA_Type=="LX" || all_list1[i].CodeA_Type=="TX") {
					var d = new Option("〓〓 카테고리 〓〓");
					document.forms[0].code_b.options[0] = d;
					document.forms[0].code_b.options[0].value = "000";

					var d = new Option("〓〓 카테고리 〓〓");
					document.forms[0].code_c.options[0] = d;
					document.forms[0].code_c.options[0].value = "000";

					var d = new Option("〓〓 카테고리 〓〓");
					document.forms[0].code_d.options[0] = d;
					document.forms[0].code_d.options[0].value = "000";
				} else {
					var d = new Option("〓〓 2차 카테고리 〓〓");
					document.forms[0].code_b.options[0] = d;
					document.forms[0].code_b.options[0].value = "";
					for(var j=0;j<all_list1[i].CodeB.length;j++) {
						...
						document.forms[0].code_b.options[j+1] = d;
						document.forms[0].code_b.options[j+1].value = all_list1[i].CodeB[j].CodeB;
						if (all_list1[i].CodeB[j].CodeB == code_b) {
							document.forms[0].code_b.selectedIndex = j+1;
							if(typeof(document.forms[0].code_c)!="object") return;
							try {
								if(all_list1[i].CodeB[j].CodeB_Type=="LMX" || all_list1[i].CodeB[j].CodeB=="TMX") {
									...
									document.forms[0].code_c.options[0] = d;
									document.forms[0].code_c.options[0].value = "";
									for(var y=0;y<all_list1[i].CodeB[j].CodeC.length;y++) {
										...
										document.forms[0].code_c.options[y+1] = d;
										document.forms[0].code_c.options[y+1].value = all_list1[i].CodeB[j].CodeC[y].CodeC;
										if (all_list1[i].CodeB[j].CodeC[y].CodeC == code_c) {
											document.forms[0].code_c.selectedIndex = y+1;
											if(typeof(document.forms[0].code_d)!="object") return;
											try {
												if(all_list1[i].CodeB[j].CodeC[y].CodeC_Type=="LMX" || all_list1[i].CodeB[j].CodeC[y].CodeC_Type=="TMX") {
													var d = new Option("〓〓 카테고리 〓〓");
													document.forms[0].code_d.options[0] = d;
													...
													document.forms[0].code_d.options[0] = d;
													document.forms[0].code_d.options[0].value = "";
													for(var z=0;z<all_list1[i].CodeB[j].CodeC[y].CodeD.length;z++) {
														var d = new Option(all_list1[i].CodeB[j].CodeC[y].CodeD[z].CodeD_Name);
														document.forms[0].code_d.options[z+1] = d;
														document.forms[0].code_d.options[z+1].value = all_list1[i].CodeB[j].CodeC[y].CodeD[z].CodeD;
														if (all_list1[i].CodeB[j].CodeC[y].CodeD[z].CodeD == code_d) {
															document.forms[0].code_d.selectedIndex = z+1;
														}
													}
												}
											} catch (e) {}
...
function SearchChangeCate(sel, gbn) {
	if (gbn == 1) {
		...
		if(typeof(document.forms[0].code_b)=="object") {
			document.forms[0].code_b.length = 0;
			var d = new Option("〓〓 2차 카테고리 〓〓");
			document.forms[0].code_b.options[0] = d;
			document.forms[0].code_b.options[0].value = "";
		}

		if(typeof(document.forms[0].code_c)=="object") {
			document.forms[0].code_c.length = 0;
			var d = new Option("〓〓 3차 카테고리 〓〓");
			document.forms[0].code_c.options[0] = d;
			document.forms[0].code_c.options[0].value = "";
		}

		if(typeof(document.forms[0].code_d)=="object") {
			document.forms[0].code_d.length = 0;
			var d = new Option("〓〓 4차 카테고리 〓〓");
			document.forms[0].code_d.options[0] = d;
			document.forms[0].code_d.options[0].value = "";
		}
		...
		var code_a=document.forms[0].code_a.value;
		for(var i=0;i<all_list1.length;i++) {
			if (all_list1[i].CodeA == code_a) {
				try {
					for(var j=0;j<all_list1[i].CodeB.length;j++) {
		...
		var code_a = document.forms[0].code_a.value;
		var code_b = document.forms[0].code_b.value;
		for(var i=0;i<all_list1.length;i++) {
			if (all_list1[i].CodeA == code_a) {
				try {
					for(var j=0;j<all_list1[i].CodeB.length;j++) {
...
function CodeInit() {
	...
	for(i=0;i<lista.length;i++) {
		if(lista[i].type=="L" || lista[i].type=="T" || lista[i].type=="LX" || lista[i].type=="TX") {//대카테고리 뽑기
