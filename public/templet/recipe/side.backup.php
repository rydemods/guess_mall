...
<script type="text/javascript">
					$(document).ready(function(){	
						var sudoSlider = $("#sidemenu_contents").sudoSlider({
							effect: "slide",
							continuous:true,
							slideCount:1,
							prevNext:false,
							moveCount:1,
							customLink:'a.sidemenu',
							auto:false
					   });
					});
				</script>
			...
			<ul>
				<li class="type2">
				  <dl>
					...
					<dd class="first"><a href="#">안티에이징</a></dd>
					<dd><a href="#" class="over">화이트닝</a></dd>
					<dd><a href="#" class="over">보습</a></dd>
					<dd><a href="#" class="over">아크네</a></dd>
					<dd><a href="#" class="over">아토라인</a></dd>
					<dd><a href="#" class="over">모공각질</a></dd>
					<dd><a href="#" class="over">클렌징</a></dd>
				  </dl>
				</li>
			</ul>						
</div>							
	...
	<ul>
				<li class="type1">
				  <dl>
					...
					<dd class="first"><a href="#">중복합성</a></dd>
					<dd><a href="#" class="over">노화,건성</a></dd>
					<dd><a href="#" class="over">아크네</a></dd>
					<dd><a href="#" class="over">아토라인</a></dd>
					<dd><a href="#" class="over">모든피부타입</a></dd>
					<dd><a href="#" class="over">남성</a></dd>
				  </dl>
				</li>
				</ul>						
...
.s_search .overlabel label{ position:absolute; top:1px; left:3px; cursor:text;}
   ...
   <div class="s_search">
	 ...
	 <label for="keyword1">레시피를 검색해보세요</label>
				<fieldset>
					  <legend>검색</legend>					
   					  <ul>
					  	<li style="float:left"><input id="keyword1" name="search_word" class="inputTypeText1" value="<?=$_REQUEST[search_word]?>" type="text" /></li>
	...
	<div class="s_banner">
	<img src="/image/main/side_banner.gif" alt="D.I.Y academy" />
	</div>
