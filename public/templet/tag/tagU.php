...
if($num=strpos($body,"[TAGSEARCHINPUT_")) {
	...
	$search_input_pattern="[TAGSEARCHINPUT_".$s_tmp[1]."]";
}
...
//[TAGSEARCHINPUT((\_){0,1})([0-9a-zA-Z\.\-\:\;\%\#\ ]){0,}] 패턴부분 을 변수로 대체 2013-07-22

$pattern=array("[TAGDATESTART]","[TAGDATEEND]","[TAGSORT1]","[TAGSORT2]","[TAGLIST]",$search_input_pattern,"[TAGSEARCHOK]");
