...
<table width="664" cellpadding="0" cellspacing="0" border="0" align="center" style="font-size:12px; color:#5e5e5e; font-family:dotum;">
	...
	<tr height="260">
		<td colspan="2" align="center"><img src="http://[URL]static/img/automail/ment_order_ok.jpg" alt="주문이 완료 되었습니다. 입금확인이 되면 상품 배송이 준비됩니다." /></td>
	</tr>
</table><!-- //상단 -->
...
<table width="600" cellpadding="0" cellspacing="0" border="0" align="center">
	<tr>
		<td align="left" style="font-size:12px; color:#5e5e5e; font-family:dotum;">
			...
			<?=date("Y/m/d")?> 주문이 완료되었습니다.<br />
			핫티 쇼핑몰에서 주문해주셔서 감사합니다.<br />
...
?>
						<td style="text-indent:10px">무통장입금 / [PAYDATA]</td>
<?php
} elseif( $_ord->paymethod[0] == 'O' ) { 
?>
						<td style="text-indent:10px">[PAYTYPE] / [PAYDATA]</td>
<?
} else {
?>
