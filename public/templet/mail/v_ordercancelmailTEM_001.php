...
<table width="664" cellpadding="0" cellspacing="0" border="0" align="center" style="font-size:12px; color:#5e5e5e; font-family:dotum;">
	...
	<tr height="260">
		<td colspan="2" align="center"><img src="http://[URL]static/img/automail/title_order_cancel.jpg" alt="주문취소안내" /></td>
	</tr>
</table><!-- //상단 -->
...
<table width="600" cellpadding="0" cellspacing="0" border="0" align="center">
	<tr>
		<td align="left" style="font-size:12px; color:#5e5e5e; font-family:dotum;">
			...
			고객님께서 요청하신 취소처리가 완료되었습니다. <br />
            고객님의 결제완료 단계에 취소 요청이나, 주문일로부 D+5일 이내에 입금 미확인, 또는 기타 사유 등의 의해 주문이 취소 처리 되었습니다. <br />
            결제 완료 단계에서의 취소 요청건은 환불이 진행될 예정입니다.<br />
            자세한 내역은 MyPage > 주문/배송 내역에서 확인하실 수 있습니다.<br />
			핫티 쇼핑몰에서 주문해주셔서 감사합니다.
			</div>
		</td>
	</tr>
