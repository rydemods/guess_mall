...
<table width="664" cellpadding="0" cellspacing="0" border="0" align="center" style="font-size:12px; color:#5e5e5e; font-family:dotum;">
	...
	<tr height="260">
		<td colspan="2" align="center"><img src="http://[URL]static/img/automail/title_request_exchange.jpg" alt="교환요청안내" /></td>
	</tr>
</table><!-- //상단 -->
...
<table width="600" cellpadding="0" cellspacing="0" border="0" align="center">
	<tr>
		<td align="left" style="font-size:12px; color:#5e5e5e; font-family:dotum;">
			...
			고객님께서 요청하신 교환신청이 접수되었습니다. <br />
			핫티 쇼핑몰을 이용해주셔서 감사합니다.
			</div>
		</td>
	</tr>
	...
	<tr>
		<td>
				...
				<table  width="600" cellpadding="0" cellspacing="0" border="0" style="font-size:12px; color:#5e5e5e; font-family:dotum;">
					<caption style="font-size:14px;font-weight:bold; text-align:left; background-color:#fff">교환요청안내</caption>
					<colgroup>
...
foreach( $orderproduct as $vender => $venderObj ){
	...
	# 상품별 배송료, 총합계금액 조회
	$deli_data=pmysql_fetch_object(pmysql_query("select sum(deli_price) as deli_price, sum((price+option_price)*option_quantity) as sum_price, sum(use_point) as sum_use_reserve, sum(coupon_price) as sum_dc_price from tblorderproduct where ordercode='".$venderObj[0]->ordercode."' and oc_no='".$venderObj[0]->oc_no."' and vender='".$venderObj[0]->vender."'"));
...
?>
	...
	<tr>
		<td>
				...
				<table  width="600" cellpadding="0" cellspacing="0" border="0" style="font-size:12px; color:#5e5e5e; font-family:dotum;">
					<caption style="font-size:14px;font-weight:bold; text-align:left; background-color:#fff">교환정보</caption>
					<colgroup>
						<col style="width:130px" /><col style="width:auto" />
					</colgroup>
					<tr><td colspan="2" height="2" bgcolor="#505050"></td></tr>
					<tr height="30"  align="left">
						<td bgcolor="#fafafa" style="text-indent:10px"><b>교환 신청 완료</b></td>
						<td style="text-indent:10px">[CURDATE]</td>
					</tr>
					<tr><td colspan="2" height="1" bgcolor="#d5d5d5"></td></tr>
					<tr height="30"  align="left">
						<td bgcolor="#fafafa" style="text-indent:10px"><b>교환 신청 사유</b></td>
						<td style="text-indent:10px">[CANCELMEMO]</td>
					</tr>
					<tr><td colspan="2" height="1" bgcolor="#d5d5d5"></td></tr>
					<tr height="30"  align="left">
						<td bgcolor="#fafafa" style="text-indent:10px"><b>교환 정보</b></td>
						<td style="text-indent:10px"><?=implode(" / ", $option_name_change)?></td>
					</tr>
					<tr><td colspan="2" height="1" bgcolor="#d5d5d5"></td></tr>
				</table>
	...
	<tr>
		<td>
				...
				<table  width="600" cellpadding="0" cellspacing="0" border="0" style="font-size:12px; color:#5e5e5e; font-family:dotum;">
					...
					<tr><td colspan="2" height="2" bgcolor="#505050"></td></tr>
					<tr height="30"  align="left">
						<td bgcolor="#fafafa" style="text-indent:10px"><b>수취인성명</b></td>
						<td style="text-indent:10px">[RECEIVERNAME]</td>
					</tr>
					<tr><td colspan="2" height="1" bgcolor="#d5d5d5"></td></tr>
					<tr height="30"  align="left">
						<td bgcolor="#fafafa" style="text-indent:10px"><b>연락처</b></td>
						<td style="text-indent:10px">[RECEIVERTELL2] / [RECEIVERTELL1]</td>
					</tr>
					<tr><td colspan="2" height="1" bgcolor="#d5d5d5"></td></tr>
					<tr height="30"  align="left">
						<td bgcolor="#fafafa" style="text-indent:10px"><b>배송지 주소</b></td>
						<td style="text-indent:10px">[RECEIVERADDR]</td>
					</tr>
					<tr><td colspan="2" height="1" bgcolor="#d5d5d5"></td></tr>
					<tr height="30"  align="left">
						<td bgcolor="#fafafa" style="text-indent:10px"><b>배송시 요청사항</b></td>
	...
	<tr>
		<td align="left" style="font-size:12px; color:#5e5e5e; font-family:dotum;">
			<div><b><span style="color:#000">교환완료안내</b></div>
			<div style="padding-top:5px;line-height:1.2;">
			교환신청 접수 후에 필요한 사항이 있을 경우 고객님께 별도의 전화를 드리게 되며 전화상담 후에 최종 결정됩니다.
			</div>
		</td>
	</tr>
