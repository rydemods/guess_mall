...
?>			
			<h4 class="mypage-title align-top">마일리지 현황</h4>
			<table class="th-top util">
				...
				<tbody>
					<tr class="my-mileage">
						<td>현재 마일리지는 <?=number_format( $reserve )?> 입니다.</td>
...
?>
			...
			<h4 class="mypage-title coupon-list3">마일리지 내역</h4>
			<!-- 날짜 설정 -->
			<form name="form1" action="<?=$_SERVER['PHP_SELF']?>">
