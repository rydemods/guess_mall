...
<tr>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td><IMG SRC="<?=$Dir?>images/common/myreserve/<?=$_data->design_myreserve?>/mypersonal_skin3_t1.gif" border="0"></td>
			<td width="100%" background="<?=$Dir?>images/common/myreserve/<?=$_data->design_myreserve?>/mypersonal_skin3_t2.gif"></td>
			<td><IMG SRC="<?=$Dir?>images/common/myreserve/<?=$_data->design_myreserve?>/mypersonal_skin3_t3.gif" border="0"></td>
		</tr>
		<tr>
			<td background="<?=$Dir?>images/common/myreserve/<?=$_data->design_myreserve?>/mypersonal_skin3_t4.gif"></td>
			<td width="100%" background="<?=$Dir?>images/common/myreserve/<?=$_data->design_myreserve?>/mypersonal_skin3_tbg.gif" style="padding:20px;">
			...
			<td background="<?=$Dir?>images/common/myreserve/<?=$_data->design_myreserve?>/mypersonal_skin3_t7.gif"></td>
		</tr>
		<tr>
			<td><IMG SRC="<?=$Dir?>images/common/myreserve/<?=$_data->design_myreserve?>/mypersonal_skin3_t5.gif" border="0"></td>
			<td width="100%" background="<?=$Dir?>images/common/myreserve/<?=$_data->design_myreserve?>/mypersonal_skin3_t6.gif"></td>
			<td><IMG SRC="<?=$Dir?>images/common/myreserve/<?=$_data->design_myreserve?>/mypersonal_skin3_t8.gif" border="0"></td>
		</tr>
		</table>
		</td>
	</tr>
	...
	<tr>
		...
		<col width="80"></col>
		<tr>
			<td height="2" colspan="4" bgcolor="#13A2DA"></td>
		</tr>
