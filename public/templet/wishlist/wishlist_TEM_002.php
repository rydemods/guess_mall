			...
			<div class="right_section">
				...
				<div class="right_article_wrap">
					<div class="right_article">
						...
						<!-- 주소복사 -->
						<p class="local_copy"><span><a href="<?=$Dir.MainDir?>main.php">홈</a> > <a href="mypage.php">마이페이지</a> > WishList </span></p>
						<!-- #주소복사 -->
...
?>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td><A HREF="javascript:CheckBoxAll()"  class="btn_white_check">전체선택</A> <A HREF="javascript:GoDelete()" class="btn_white_check">선택상품 삭제</td>
...
<?
		...
		while($row=pmysql_fetch_object($result)) {
			...
			echo "		<td align=\"center\"><A HREF=\"javascript:CheckForm('',".$row->wish_idx.")\" class=\"btn_ty03\">장바구니담기</A></td>\n";
			echo "	</tr>\n";
			echo "	<tr>\n";
			...
			echo "		</table>\n";
			echo "		</td>\n";
			echo "		<td align=\"center\"><A HREF=\"javascript:CheckForm('ordernow',".$row->wish_idx.")\" class=\"btn_ty01\">바로 구매하기</A></td>\n";
			echo "	</tr>\n";
			echo "	<tr>\n";
			echo "		<td style=\"padding-left:5px;padding-right:5px;\">\n";
			echo "		<table cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" class=\"style_none\">\n";
			...
			echo "		</table>\n";
			echo "		</td>\n";
			echo "		<td align=\"center\"><A HREF=\"javascript:SaveMemo(".$row->wish_idx.")\"  class=\"btn_ty02\">저장하기</A></td>\n";
			echo "	</tr>\n";
			echo "	</table>\n";
			echo "	</td>\n";
			echo "</tr>\n";
