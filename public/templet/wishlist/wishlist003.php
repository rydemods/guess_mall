...
?>
	<tr>
		<td>
		<table cellpadding="0" cellspacing="8" width="100%" bgcolor="#EFEFEF">
		<tr>
			<td width="100%" background="<?=$Dir?>images/common/wishlist/<?=$_data->design_wishlist?>/design_search_skin1_tbg.gif" style="padding:20px;">
