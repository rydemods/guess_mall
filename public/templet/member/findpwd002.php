...
<tr>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td><IMG SRC="<?=$Dir?>images/member/idsearch_skin2_img01.gif" border="0"></td>
				...
				<td><A HREF="javascript:CheckForm()"><img src="<?=$Dir?>images/member/idsearch_skin2_pwbtn.gif" border="0"></a></td>
			</tr>
			</table>
			</td>
		</tr>
	...
	<tr>
		<td align="center"><A HREF="<?=$Dir.FrontDir?>login.php"><img src="<?=$Dir?>images/member/idsearch_skin2_loginbtn.gif" border="0"></a></td>
	</tr>
	</table>
	</td>
</tr>
