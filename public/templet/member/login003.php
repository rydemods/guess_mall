...
<tr>
	...
	<tr>
		...
		<col width="18"></col>
		<tr>
			<td><IMG SRC=[DIR]images/member/login_con_tabletopl_skin3.gif border="0"></td>
			<td background=[DIR]images/member/login_con_tabletopc_skin3.gif></td>
			<td><IMG SRC=[DIR]images/member/login_con_tabletopr_skin3.gif border="0"></td>
		</tr>
		<tr>
			<td background=[DIR]images/member/login_con_tableleft_skin3.gif></td>
			<td valign="top" bgcolor="#F6F3F0">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td>
				<table cellpadding="0" cellspacing="0" width="100%">
					...
					<tr>
						...
						<tr>
							...
							<tr>
								...
								<tr>
									<td><img src=[DIR]images/member/login_con_text5a_2_skin3.gif border="0" hspace="10"></td>
									<td>[ORDERCODE]</td>
								</tr>
								</table>
								</td>
								<td><a href=[ORDEROK]><IMG SRC=[DIR]images/member/login_con_btn2_skin3.gif border="0" hspace="10"></a></td>
							</tr>
							</table>
							</td>
						</tr>
			...
			<td background=[DIR]images/member/login_con_tableright_skin3.gif></td>
		</tr>
		<tr>
			<td><IMG SRC=[DIR]images/member/login_con_tabledownl_skin3.gif border="0"></td>
			<td background=[DIR]images/member/login_con_tabledownc_skin3.gif></td>
			<td><IMG SRC=[DIR]images/member/login_con_tabledownr_skin3.gif border="0"></td>
		</tr>
		</table>
		</TD>
	</tr>
