...
?>		
	...
	<tr>
		<td align="center"><a href="javascript:CheckForm('<?=$mem_type?>');"><img src="<?=$Dir?>images/common/mbjoin/<?=$_data->design_mbjoin?>/memberjoin_skin3_btn3.gif" border="0"></a><a href="javascript:history.go(-1);";><img src="<?=$Dir?>images/common/mbjoin/<?=$_data->design_mbjoin?>/memberjoin_skin3_btn4.gif" border="0" hspace="6"></a></td>
	</tr>
	<tr>
		<td height="20"></td>
	</tr>
