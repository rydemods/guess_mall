...
?>
				...
				<table cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td><font color="#3974CF" style="font-size:15px;letter-spacing:-0.5pt;word-break:break-all;"><b><?=viewproductname($_pdata->productname,$_pdata->etctype,"")?></b></font></td>
				</tr>
				<tr>
					<td height="5"></td>
				</tr>
				<tr>
					<td HEIGHT="3" bgcolor="#3974CF"></td>
				</tr>
				<tr>
					<td height="5" bgcolor="#F5FDFF"></td>
				</tr>
				<tr>
					<td width="100%">
					<table cellpadding="0" cellspacing="0" width="100%" bgcolor="#F5FDFF">
	...
	if(typeof(document.form1.package_idx)=="object") {
		...
		if(typeof(document.form1.dollarprice)=="object") {
			...
			if(document.getElementById("idx_price_graph")) {
				...
				<tr>
					<td height="3" bgcolor="#F5FDFF"></td>
				</tr>
				<tr>
					<td HEIGHT="3" bgcolor="#356DC2"></td>
				</tr>
				<tr>
					<td height="10"></td>
				</tr>
...
<?
				if(strlen($dicker)==0) {
					if(strlen($_pdata->quantity)>0 && $_pdata->quantity<=0)
						...
						echo "<a href=\"javascript:CheckForm('','".$opti."')\" onMouseOver=\"window.status='장바구니담기';return true;\"><IMG SRC=\"".$Dir."images/common/product/".$_cdata->detail_type."/pdetail_skin_btn02.gif\" hspace=\"3\" border=\"0\" align=\"center\" onMouseDown=\"eval('try{ _trk_clickTrace( \'SCI\', \'".$_pdata->productname."\' ); }catch(_e){ }');\"></a>\n";
					}
		...
		<tr>
			...
			<tr>
				...
				.taglist	{
					...
					border:2px solid #4561DC;padding:0px 0px 0px 0px;
				}
				.taglist_on	{
...
<?
	...
	if(strlen($deli_info)>0) {
		...
		echo "		<tr>\n";
		echo "			<td><a href=\"#1\"><img src=\"".$Dir."images/common/product/".$_cdata->detail_type."/pdetail_skin_detailtitle1r.gif\" border=\"0\"></td>\n";
		echo "			<td><a href=\"#2\"><img src=\"".$Dir."images/common/product/".$_cdata->detail_type."/pdetail_skin_detailtitle2r.gif\" border=\"0\"></a></td>\n";
...
?>
		...
		<tr>
			...
			<tr>
				...
				<?php include($Dir.FrontDir."prreview.php"); ?>
				</td>
			</tr>
			</table>
			</td>
		...
		<tr>
			...
			<tr>
				...
				<?php include($Dir.FrontDir."prqna.php"); ?>
				</td>
			</tr>
			</table>
			</td>
