...
<?
			...
			while($row=pmysql_fetch_object($result)) {
				...
				if($i>0 && $i%3==0) echo "</tr><tr><td colspan=\"3\" height=\"1\" background=\"".$Dir."images/common/product/".$_cdata->list_type."/plist_skin_table01.gif\"></td></tr><tr><td height=\"5\"></td></tr><tr>\n";
?>
