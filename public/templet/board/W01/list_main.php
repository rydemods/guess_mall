	...
	<tr>
		...
		<TR bgcolor="F6F5EE" align="center">
			...
			<TD nowrap background="<?=$imgdir?>/board_skin1_t_bg.gif"><nobr><B><font color="#00FFFF" style="font-size:8pt;"><?=$str_name?></font></TD>
			<TD nowrap background="<?=$imgdir?>/board_skin1_t_bg.gif"><nobr>
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
			...
			<?} else {?>
			<TD nowrap background="<?=$imgdir?>/board_skin1_t_bg.gif"><nobr><B><font color="#00FFFF" style="font-size:8pt;"><?=$str_name?></font></TD>
			<TD nowrap background="<?=$imgdir?>/board_skin1_t_bg.gif"><nobr><font color="#4B4B4B" style="font-size:8pt;">조회 : <?=$hit?></font></TD>
			<TD nowrap background="<?=$imgdir?>/board_skin1_t_bg.gif"><nobr>
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td align="center"><font color="#4B4B4B" style="font-size:8pt;"><?=$reg_date?></font></TD>
