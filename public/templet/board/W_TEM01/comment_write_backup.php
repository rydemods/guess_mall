			...
			<tr>
				...
				<TABLE border="0" cellSpacing="0" cellPadding="0" width="100%" bgColor="f4f4f4" style="table-layout:fixed">
				<TR>
				...
				<TR align="center">
					...
					<tr>
						...
						<td align="center"><a href="javascript:document.comment_form.submit()" class="btn_white_check02">등록</A></TD>
					</tr>
					</table>
