<?if($_data->icon_type == 'tem_001'){ ?>
		...
		<div class="board-view">
			<p class="title">
				<?=$strSubject?>
				<span><?=$strName?></span>
				<span class="date"><?=str_replace("/", "-", $strDate)?></span>
			</p>
			...
			<? if (count($file_name1)) { ?>
			<!--<div>
				<ul><font color="#FF6600">첨부파일 : <?=implode(",",$file_name1)?></font></ul>
			</div><br>-->
			<? } ?>
...
<tr>
	...
	<tr>
		...
		<TR>
			<TD height="30" align="right" style="padding-right:5px;" class="list_text"><B><?=$strName?></B><?=(($strDate || !$hide_hit_start)?", ":"")?><?=$strDate?><?=$strDate?", ":""?><?=($hide_hit_start?"":"HIT : ".$v_access)?></TD>
		</TR>
		<TR>
