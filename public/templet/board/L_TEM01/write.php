...
<?if($_data->icon_type == 'tem_001'){?>
	...
	<div class="right_section mb_80">
		...
		<h3 class="title"><?=$setup[board_name]?><!-- <p class="line_map"><a><img src="../img/icon/home.gif" alt="" /> 홈</a> &gt; <a>고객센터</a></p> --></h3>
  ...
  <div class="board_writeWrap">
		...
		if($recipe_no){
			$rdata = $recipe->getRecipeDetail($recipe_no);
			$link = $Dir.FrontDir."recipe_view.php?no=".$rdata[no]."&listUrl=".urlencode("/front/recipe.php");
			include("recipe_top_tem001.php");
		}
...
-->
	...
	<ul>
		<li><a href="javascript:history.go(-1);" class="btn_D">이전으로</a></li>
		<li><a href="<?=$_SERVER[REQUEST_URI]?>" class="btn_D">초기화</a></li>
		<li><a href="#" onclick="chk_writeForm(document.writeForm); return false;" class="btn_D on" >확인</a></li>
	</ul>
	</div>
