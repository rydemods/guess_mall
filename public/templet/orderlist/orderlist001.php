...
<tr>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td><img src="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/design_search_skin3_t1.gif" border="0"></td>
			<td width="100%" background="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/design_search_skin3_t1bg.gif"></td>
			<td><img src="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/design_search_skin3_t4.gif" border="0"></td>
		</tr>
		<tr>
			<td background="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/design_search_skin3_t2bg.gif"></td>
			<td background="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/design_search_skin3_tbg.gif" style="padding:20px;">
			...
			<td background="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/design_search_skin3_t4bg.gif"></td>
		</tr>
		<tr>
			<td><img src="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/design_search_skin3_t2.gif" border="0"></td>
			<td width="100%" background="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/design_search_skin3_t3bg.gif"></td>
			<td><img src="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/design_search_skin3_t3.gif" border="0"></td>
		</tr>
		</table>
		</td>
	</tr>
	...
	<tr>
		...
		<tr>
			<td height="2" colspan="5" bgcolor="#13A0DA"></td>
		</tr>
		</TABLE>
		</td>
	</tr>
