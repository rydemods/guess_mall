			...
			<div class="right_section">
				...
				<div class="right_article_wrap">
					<div class="right_article">
						...
						<!-- 주소복사 -->
						<p class="local_copy"><span><a href="<?=$Dir.MainDir?>main.php">홈</a> > <a href="mypage.php">마이페이지</a> > 주문내역 </span></p>
						<!-- #주소복사 -->
	...
	<tr>
		<td>
			...
			<tr>
				...
				<td>
					<A HREF="javascript:GoSearch('TODAY')"><img src="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/orderlist_skin3_btn01.gif" border="0" align="absmiddle"></A>
					...
					<A HREF="javascript:GoSearch('6MONTH')"><img src="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/orderlist_skin3_btn05.gif" border="0" hspace="2" align="absmiddle"></A>
				</td>
			</tr>
			<tr>
