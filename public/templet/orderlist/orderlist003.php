...
<tr>
	...
	<tr>
		...
		<TR>
			...
			<TD width="100%" background="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/mypersonal_skin1_menubg.gif"></TD>
		</TR>
		<tr>
...
?>
	...
	<tr>
		...
		<tr>
			...
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>	
				<td><IMG SRC="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/orderlist_skin1_tablet01_1.gif" border="0"></td>
				<td width="100%" background="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/orderlist_skin1_tablet01_2.gif"></td>
				<td><IMG SRC="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/orderlist_skin1_tablet01_3.gif" border="0"></td>
			</tr>
			<tr>
				<td background="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/orderlist_skin1_tablet02_1.gif" border="0"></td>
				<td style="padding:10px;">
				<table cellpadding="0" cellspacing="0">
				<tr>
					<td><IMG SRC="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/orderlist_skin1_table_img01.gif" border="0"></td>
					<td style="padding-left:5px;"><IMG SRC="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/orderlist_skin1_table_line.gif" border="0"></td>
					<td><IMG SRC="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/orderlist_skin1_table_img02.gif" border="0"></td>
					<td style="padding-left:5px;"><IMG SRC="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/orderlist_skin1_table_line.gif" border="0"></td>
					<td><IMG SRC="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/orderlist_skin1_table_img03.gif" border="0"></td>
					<td style="padding-left:5px;"><IMG SRC="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/orderlist_skin1_table_line.gif" border="0"></td>
					<td><IMG SRC="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/orderlist_skin1_table_img04.gif" border="0"></td>
				</tr>
				</table>
				</td>
				<td background="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/orderlist_skin1_tablet02_2.gif"></td>
			</tr>
			<tr>
				<td><IMG SRC="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/orderlist_skin1_tablet03_1.gif" border="0"></td>
				<td width="100%" background="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/orderlist_skin1_tablet03_2.gif"></td>
				<td><IMG SRC="<?=$Dir?>images/common/orderlist/<?=$_data->design_orderlist?>/orderlist_skin1_tablet03_3.gif" border="0"></td>
			</tr>
			</table>
			</td>
		</tr>
