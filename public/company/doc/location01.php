...
<?php include "../outline/header.php"; ?>
	...
	<div class="container960 mb_50">
		<ul class="tap_ea2">
			<li><a href="location01.php"><img src="../img/common/map_tap01_on.gif" alt="본사 오시는 길" /></a></li>
			<li><a href="location02.php"><img src="../img/common/map_tap02_off.gif" alt="직영점 오시는 길" /></a></li>
		</ul>
		<img src="../img/common/location01.jpg" alt="본점" />
	</div>
