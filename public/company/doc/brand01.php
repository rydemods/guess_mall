...
<script type="text/javascript" src="<?=$Dir?>js/jquery.sudoSlider.js"></script>
	...
	<div class="container960 mb_50">
		<div class="left_rolling">
			<a href="javascript:void(0)" data-target="prev" class="left">왼쪽</a>
			<a href="javascript:void(0)" data-target="next" class="right">오른쪽</a>
			<div  class="m_banner_slider">
			<!--<ul class="tap_ea5">-->
				<?
					$bannerCount = 0;
					foreach($homeBanner['home_brand'] as $v){
						if($v["banner_hidden"]){
				?>
							<?if($bannerCount==0){?>
								<ul class="tap_ea5">
...
<!--
	$(document).ready(function(){
		...
		var sudoSlider = $("div.m_banner_slider").sudoSlider({
			effect: "slide",
			continuous:true,
			slideCount:5,
			prevNext:false,
			moveCount:1,
			customLink:'div.left_rolling a',
			auto:true,
			animationZIndex:80
	  	});
