...
<tr>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td valign="top" background="<?=$Dir?>images/<?=$_data->icon_type?>/main_skin1_top_cate_bg.gif" style="padding-left:20px;padding-right:15px;">
...
<?
				...
				while($row=pmysql_fetch_object($result)) {
					...
					echo "<tr>\n";
					echo "	<td height=\"25\"><IMG SRC=\"".$Dir."images/".$_data->icon_type."/main_skin1_categorynero.gif\" border=\"0\" align=\"absmiddle\"></td>\n";
...
<? if($_data->ETCTYPE["BRANDLEFT"]=="Y" && (($_data->ETCTYPE["BRANDLEFTL"]=="Y" && ($brandpagemark == "Y" || $mainpagemark == "Y")) || ($_data->ETCTYPE["BRANDLEFTL"]=="B" && $brandpagemark == "Y") || $_data->ETCTYPE["BRANDLEFTL"]=="A")) { ?>
		<tr>
			...
			<tr>
				<td background="<?=$Dir?>images/<?=$_data->icon_type?>/main_skin1_brand_bg.gif" style="padding-left:15px;padding-right:15px;">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
			...
			<tr>
				<td><IMG SRC="<?=$Dir?>images/<?=$_data->icon_type?>/main_skin1_brand_down.gif" border="0"></td>
			</tr>
			</table>
			</td>
		</tr>
...
?>
		...
		<tr>
			...
			<tr>
				<td background="<?=$Dir?>images/<?=$_data->icon_type?>/main_skin1_com_bg.gif" style="padding-left:15px;padding-right:15px;">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
<?
...
?>
		...
		<tr>
			...
			<tr>
				<td background="<?=$Dir?>images/<?=$_data->icon_type?>/main_skin1_customerbg.gif" style="padding-left:30px;">
				<table cellpadding="0" cellspacing="0" width="100%">
<?
