...
$mainsec_strN.="	<TR>\n";
$mainsec_strN.="		<TD background=".$Dir."images/".$_data->icon_type."/main_skin3_newarrivalbg_head.gif align=center><img src=".$Dir."images/".$_data->icon_type."/main_skin3_newarrivalbg_head.gif border=0></TD>\n";
$mainsec_strN.="		<TD width=100% align=center>\n";
...
if(strlen($sp_prcode)>0) {
	...
	if($main_new_type=="I") {	//이미지A형
		...
		while($row=pmysql_fetch_object($result)) {
			...
			$mainsec_strN.="	></A></td>";
			$mainsec_strN.="	<td style=\"position:relative;\">".($_data->ETCTYPE["QUICKTOOLS"]!="Y"?"<script>quickfun_write('".$Dir."','N','".$row->productcode."','".($row->quantity=="0"?"":"1")."','row')</script>":"")."</td>";
			$mainsec_strN.="	<td style=\"padding-right:5px;word-break:break-all;\" align=\"left\"><A HREF=\"".$Dir.FrontDir."productdetail.php?productcode=".$row->productcode."\" onmouseover=\"window.status='상품상세조회';return true;\" onmouseout=\"window.status='';return true;\"><FONT class=\"mainprname\">".viewproductname($row->productname,$row->etctype,$row->selfcode)."</FONT></A>";
			if($_data->ETCTYPE["TAGTYPE"]=="Y") {
				$taglist=explode(",",$row->tag);
				$jj=0;
...
$mainsec_strN.="		</td>\n";
$mainsec_strN.="		<TD background=".$Dir."images/".$_data->icon_type."/main_skin3_newarrivalbg_tail.gif><img src=".$Dir."images/".$_data->icon_type."/main_skin3_newarrivalbg_tail.gif border=0></TD>\n";
$mainsec_strN.="	</TR>\n";
$mainsec_strN.="	</TABLE>\n";
$mainsec_strN.="	</td>\n";
$mainsec_strN.="</tr>\n";
...
$mainsec_strN.="	<TR>\n";
$mainsec_strN.="		<TD><img src=".$Dir."images/".$_data->icon_type."/main_skin3_newarrival_d_head.gif border=0></TD>\n";
$mainsec_strN.="		<TD width=100% background=".$Dir."images/".$_data->icon_type."/main_skin3_newarrival_d_bg.gif></TD>\n";
$mainsec_strN.="		<TD><img src=".$Dir."images/".$_data->icon_type."/main_skin3_newarrival_d_tail.gif border=0></TD>\n";
$mainsec_strN.="	</TR>\n";
$mainsec_strN.="	</TABLE>\n";
$mainsec_strN.="	</td>\n";
$mainsec_strN.="</tr>\n";
...
if ($_data->title_type=="Y" && file_exists($Dir.DataDir."design/main_best_title.gif")) {
	...
	$mainsec_strB.="<TR>\n";
	$mainsec_strB.="	<TD><IMG SRC=".$Dir."images/".$_data->icon_type."/main_best_title_head.gif ALT=></TD>\n";
...
$mainsec_strB.="	<TR>\n";
$mainsec_strB.="		<TD valign=top><img src=".$Dir."images/".$_data->icon_type."/main_skin3_bestitembg_head.gif border=0></TD>\n";
...
$mainsec_strB.="		</td>\n";
$mainsec_strB.="		<TD valign=top><img src=".$Dir."images/".$_data->icon_type."/main_skin3_bestitembg_tail.gif border=0></TD>\n";
$mainsec_strB.="	</TR>\n";
$mainsec_strB.="	</TABLE>\n";
$mainsec_strB.="	</td>\n";
$mainsec_strB.="</tr>\n";
...
if ($_data->title_type=="Y" && file_exists($Dir.DataDir."design/main_hot_title.gif")) {
	...
	$mainsec_strH.="<TR>\n";
	$mainsec_strH.="	<TD><IMG SRC=".$Dir."images/".$_data->icon_type."/main_hot_title_head.gif ALT=></TD>\n";
...
$mainsec_strH.="	<TR>\n";
$mainsec_strH.="		<TD background=".$Dir."images/".$_data->icon_type."/main_skin3_hot_bg_head.gif align=center><img src=".$Dir."images/".$_data->icon_type."/main_skin3_hot_bg_head.gif border=0></TD>\n";
...
$mainsec_strH.="		</td>\n";
$mainsec_strH.="		<TD background=".$Dir."images/".$_data->icon_type."/main_skin3_hot_bg_tail.gif><img src=".$Dir."images/".$_data->icon_type."/main_skin3_hot_bg_tail.gif border=0></TD>\n";
$mainsec_strH.="	</TR>\n";
$mainsec_strH.="	</TABLE>\n";
$mainsec_strH.="	</td>\n";
$mainsec_strH.="</tr>\n";
...
$mainsec_strH.="	<TR>\n";
$mainsec_strH.="		<TD><img src=".$Dir."images/".$_data->icon_type."/main_skin3_hot_down_head.gif border=0></TD>\n";
$mainsec_strH.="		<TD width=100% background=".$Dir."images/".$_data->icon_type."/main_skin3_hot_down_bg.gif></TD>\n";
$mainsec_strH.="		<TD><img src=".$Dir."images/".$_data->icon_type."/main_skin3_hot_down_tail.gif border=0></TD>\n";
$mainsec_strH.="	</TR>\n";
$mainsec_strH.="	</TABLE>\n";
$mainsec_strH.="	</td>\n";
$mainsec_strH.="</tr>\n";
...
<?php if(strlen($_data->layoutdata["MAINTYPE"])==0 || $_data->layoutdata["MAINTYPE"]=="B"){?>
<tr>
	<td nowrap>
	<!-- main top start -->
	<?=$mainsec_strI?>
...
<tr>
	...
	<?php if($_data->layoutdata["MAINTYPE"]!="C"){?>
	<col></col>
	<col width="180"></col>
	<?php }?>
	<tr>
...
?>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed">
		<?php if($_data->layoutdata["MAINTYPE"]=="A"){?>
		<tr><td height=10></td></tr>
		<?php }
		###### 배너 ######
...
?>
		<tr>
			...
			<tr>
				<td background="<?=$Dir?>images/<?=$_data->icon_type?>/main_skin3_rightnotice_bg.gif" style="padding:10px;padding-top:5px;padding-bottom:5px;">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
<?php
				...
				while($row=pmysql_fetch_object($result)) {
					$i++;
					echo "<tr>\n";
					echo "	<td><IMG SRC=\"".$Dir."images/".$_data->icon_type."/main_skin3_communitynero.gif\" border=\"0\"></td>\n";
...
?>
			...
			<tr>
				<td><img src="<?=$Dir?>images/<?=$_data->icon_type?>/main_skin3_rightnotice_d.gif" border="0"></td>
			</tr>
			</table>
			</td>
		</tr>
...
?>
			...
			<tr>
				<td background="<?=$Dir?>images/<?=$_data->icon_type?>/main_skin3_rightspe_bg.gif" style="padding-left:5px;padding-right:5px;">
				<table cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td>
					<?php if($_data->main_special_type=="Y"){?>
					<SCRIPT language=JavaScript>
					<!--
					var Toggle=1;
...
?>
			...
			<tr>
				<td><IMG SRC="<?=$Dir?>images/<?=$_data->icon_type?>/main_skin3_rightspe_d.gif" border="0"></td>
			</tr>
			</table>
			</td>
		</tr>
...
?>
		...
		<tr>
			...
			<tr>
				<td background="<?=$Dir?>images/<?=$_data->icon_type?>/main_skin3_rightshop_bg.gif" style="padding:10px;padding-top:5px;padding-bottom:5px;"><?=$strinfo?></td>
			</tr>
			<tr>
				<td><IMG SRC="<?=$Dir?>images/<?=$_data->icon_type?>/main_skin3_rightshop_down.gif" border="0"></td>
			</tr>
			</table>
			</td>
		</tr>
		...
		<tr>
			...
			<tr>
				<td background="<?=$Dir?>images/<?=$_data->icon_type?>/main_skin3_rightpop_bg.gif" style="padding:10px;padding-top:5px;padding-bottom:5px;">
				<?php include($Dir."lib/poll.php"); ?></td>
			</tr>
			<tr>
				<td><IMG SRC="<?=$Dir?>images/<?=$_data->icon_type?>/main_skin3_rightpop_down.gif" border="0"></td>
			</tr>
			</table>
			</td>
		</tr>
...
<?php //이벤트 팝업창 (main???.php에만 include)?>
<?php include($Dir."lib/eventlayer.php") ?>
</BODY>
</HTML>
