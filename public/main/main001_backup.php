...
$mainsec_strB.="	<TR>\n";
$mainsec_strB.="		<TD background=".$Dir."images/".$_data->icon_type."/main_skin2_bestitem_bg_head.gif align=center><img src=".$Dir."images/".$_data->icon_type."/main_skin2_bestitem_bg_head.gif border=0></TD>\n";
...
$mainsec_strB.="		</td>\n";
$mainsec_strB.="		<TD background=".$Dir."images/".$_data->icon_type."/main_skin2_bestitem_bg_tail.gif><img src=".$Dir."images/".$_data->icon_type."/main_skin2_bestitem_bg_tail.gif border=0></TD>\n";
$mainsec_strB.="	</TR>\n";
$mainsec_strB.="	</TABLE>\n";
$mainsec_strB.="	</td>\n";
$mainsec_strB.="</tr>\n";
...
$mainsec_strB.="	<TR>\n";
$mainsec_strB.="		<TD><img src=".$Dir."images/".$_data->icon_type."/main_skin2_bestitem_down_head.gif border=0></TD>\n";
$mainsec_strB.="		<TD width=100% background=".$Dir."images/".$_data->icon_type."/main_skin2_bestitem_down_bg.gif></TD>\n";
$mainsec_strB.="		<TD><img src=".$Dir."images/".$_data->icon_type."/main_skin2_bestitem_down_tail.gif border=0></TD>\n";
$mainsec_strB.="	</TR>\n";
$mainsec_strB.="	</TABLE>\n";
$mainsec_strB.="	</td>\n";
$mainsec_strB.="</tr>\n";
...
$mainsec_strH.="	<TR>\n";
$mainsec_strH.="		<TD background=".$Dir."images/".$_data->icon_type."/main_skin2_hot_bg_head.gif align=center><img src=".$Dir."images/".$_data->icon_type."/main_skin2_hot_bg_head.gif border=0></TD>\n";
...
$mainsec_strH.="		</td>\n";
$mainsec_strH.="		<TD background=".$Dir."images/".$_data->icon_type."/main_skin2_hot_bg_tail.gif><img src=".$Dir."images/".$_data->icon_type."/main_skin2_hot_bg_tail.gif border=0></TD>\n";
$mainsec_strH.="	</TR>\n";
$mainsec_strH.="	</TABLE>\n";
$mainsec_strH.="	</td>\n";
$mainsec_strH.="</tr>\n";
...
$mainsec_strH.="	<TR>\n";
$mainsec_strH.="		<TD><img src=".$Dir."images/".$_data->icon_type."/main_skin2_hot_down_head.gif border=0></TD>\n";
$mainsec_strH.="		<TD width=100% background=".$Dir."images/".$_data->icon_type."/main_skin2_hot_down_bg.gif></TD>\n";
$mainsec_strH.="		<TD><img src=".$Dir."images/".$_data->icon_type."/main_skin2_hot_down_tail.gif border=0></TD>\n";
$mainsec_strH.="	</TR>\n";
$mainsec_strH.="	</TABLE>\n";
$mainsec_strH.="	</td>\n";
$mainsec_strH.="</tr>\n";
