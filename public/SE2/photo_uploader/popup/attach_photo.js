	...
	var elFileElem = jindo.$$.getSingle(".fileElem",elContent);
	var elFileSelect = jindo.$$.getSingle(".fileSelect",elContent);
	...
	function addEvent() {
		...
		elFileSelect.addEventListener("click", fileSelectClick, false);
		elFileElem.addEventListener("change", handleFiles, false);
	}
	...
	function removeEvent(){
		...
		elFileSelect.removeEventListener("click", fileSelectClick, false);
		elFileElem.removeEventListener("change", handleFiles, false);
	}
...
// 	    		oCustomEvent.stop(); 수행시 bAllowed 가 false이더라도 alert이 수행되지 않음
	...
	window.onload = function(){
        // 사진업로드 팝업에서 드래그화면 안나오고, 찾아보기 화면이 나오게 하기 위해 주석처리...2016-06-17 jhjeong
  		checkDragAndDropAPI();
