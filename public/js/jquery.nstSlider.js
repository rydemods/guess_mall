    ...
    var methods = {
        ...
        'init' : function(options) {
            ...
            return this.each(function() {
                ...
                //
				$("#smart_search_min_price").blur(function(){
					_methods.getSliderValuesAtPositionPx.call($this, $('#smart_search_min_price').val(), $('#smart_search_max_price').val());
					_methods.validateAndMoveGripsToPx.call($this, $('#smart_search_min_price').val(), $('#smart_search_max_price').val());

					
					_methods.validateAndMoveGripsToPx.call($this, $('#smart_search_min_price').val(), $('#smart_search_max_price').val());
					_methods.notify_mouse_up_implicit.call($this, $('#smart_search_min_price').val());
				})
