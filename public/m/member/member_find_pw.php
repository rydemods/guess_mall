					...
					<div class="tab-content-wrap">
						<div id="tab-1" class="tab-content">
							<form class="login-form">
								<fieldset>
									<legend>휴재폰인증으로 비밀번호를 찾기위한 이름 아이디 입력</legend>
									<ul class="find-input">
										<li><input class="w100-per" type="text" title="이름 입력자리" placeholder="아이디"></li>
										<li><input class="w100-per" type="text" title="아이디 입력자리" placeholder="비밀번호"></li>
									</ul>
								</fieldset>
							</form>
							<div class="btnwrap">
							...
							<form class="login-form">
								<fieldset>
									...
									<div class="login-input">
										<ul class="pos-input">
											<li class="half">
												<div><input type="text" title="이름 입력자리" placeholder="이름"></div>
												<div><input type="text" title="아이디 입력자리" placeholder="아이디"></div>
											</li>
