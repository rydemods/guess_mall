...
#---------------------------------------------------------------
	...
	//print_r($user);
	 ...
	 if($user -> email && $user -> name){		 
		...
		echo '<script> ';
		echo "window.opener.document.login_form.facebook_id.value='{$facebook_id}';";
		echo "window.opener.document.login_form.facebook_name.value='{$facebook_name}';";
		echo "window.opener.document.login_form.facebook_email.value='{$facebook_email}';";
		echo "window.opener.document.login_form.facebook_token.value='{$token}';";
		echo "window.opener.goLogin();";
		echo "window.close();";
		echo '</script>';
		exit;
