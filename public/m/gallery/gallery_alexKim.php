...
*/
	function sliderNextPage( button ){
		if( button == 'bx-next' ){
			location.href='http://test-deco.ajashop.co.kr/m/gallery/gallery_alexKim_outro.php';
		} else if( button == 'bx-prev' ){
			location.href='http://test-deco.ajashop.co.kr/m/gallery/gallery_alexKim_intro.php';
		}
	}
});
</script>
