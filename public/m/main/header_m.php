...
<!-- 	<script src="./static/js/ui.js?v=1"></script> -->
	<script src="./static/js/dev.min.js?v=11"></script>
...
'/front/promotion_detail.php','/front/promotion.php','/m/index.htm','/front/storeList.php','/front/instagramlist.php','/m/movie_list.php',
        '/m/productlist.php','/m/brand_main.php','/m/brand_detail.php','/m/ecatalog_list.php','/m/promotion.php','/m/lookbook_list.php','/m/promotion_detail.php','/front/productdetail.php','/m/productdetail.php');
