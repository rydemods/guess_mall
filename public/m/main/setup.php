...
?>
		<!-- 내용 -->
		<main id="content" class="page-setup">
			...
			<section>
				<h3>로그인</h3>
				<ul>
					<li><h4 class="login-title">CASH STORE</h4><a class="btn-login" href="#">로그인</a></li>
					<li><label class="switch">자동로그인<input type="checkbox" checked><span><strong>OFF</strong><strong>ON</strong></span></label></li>
				</ul>
			</section>
			...
			<section>
				<h3>사업자 정보 및 이용약관</h3>
				<ul>
					<li><a class="setup-link" href="#">회사소개</a></li>
					<li><a class="setup-link" href="#">이용약관</a></li>
					<li><a class="setup-link" href="#">개인정보 취급방침</a></li>
				</ul>
			</section>
