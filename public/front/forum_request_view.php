				...
				<div class="tag-wrap">
					...
					<div class="hero-info-share">
						<ul>
							...
							<li><a href="javascript:ClipCopy('http://test-hott.ajashop.co.kr/front/productdetail.php?productcode=002001001000000003');">URL</a></li>
						</ul>
					</div>
				</div>
											...
											<!--------------------------->	
												...
												<div class="re-reply-wrap">
													...
													<div class="reply-reg-box bor-t">
														...
														<div class="review_comment_form">
															<textarea class="review_comment_2" maxlength="299"></textarea>
...
<form name="modify_form" method="post" action="/front/forum_request_write.php">
...
function reply_like()
{
	...
	var num = "forum_reply_request"+$(this).data('no');
...
function resultHandler_REPLYLIKE(r_data)
{
	...
	var reply_no = r_data[0].no.replace("forum_reply_request", "");
...
function back_list()
{
	var url ="/front/forum_request_list.php?forum_code=";
