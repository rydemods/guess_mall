...
if($type=="view") {
	...
	if($newdesign!="Y") {
		if(file_exists($Dir.TempletDir."information/infoview{$_data->design_information}.php")) {
			$buffer = file_get_contents($Dir.TempletDir."information/infoview{$_data->design_information}.php");
			$body=$buffer;
		}
	}
	...
	if($newdesign!="Y") {
		if(file_exists($Dir.TempletDir."information/infolist{$_data->design_information}.php")) {
			$buffer = file_get_contents($Dir.TempletDir."information/infolist{$_data->design_information}.php");
			$body=$buffer;
		}
	}
