...
$reserve_staff=0;
$sql = "SELECT id,name,reserve,staff_reserve FROM tblmember WHERE id='".$_ShopInfo->getMemid()."' ";
$result=pmysql_query($sql,get_db_conn());
if($row=pmysql_fetch_object($result)) {
	$id      = $row->id;
	$name    = $row->name;
	$reserve_staff = $row->staff_reserve;
} else {
...
include ($Dir.TempletDir."myreserve/myreserve_staff_TEM_001.php");
echo "	</td>\n";
echo "</tr>\n";
?>
