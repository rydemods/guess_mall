...
<?php 
	...
	while($row=pmysql_fetch_object($result)) {
		...
		$sql.= "AND (a.package_num IS NULL OR a.package_num='0') ";
		...
		echo "	<tr>\n";
		echo "		<td>";
		echo "		<select name=\"prcode[{$i}]\" style=\"width:100%;background-color:#404040;color:#ffffff;\" onchange=\"calculation({$i},this.value)\">\n";
		...
		echo "	<td><input type=text name=\"prcnt[{$i}]\" value=\"1\" size=\"3\" maxlength=\"3\" style=\"text-align:right; BACKGROUND-COLOR:#F7F7F7;width:30px;\" onkeyup=\"change_cnt({$i})\"> 개</td>\n";
