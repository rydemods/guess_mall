...
while($row=pmysql_fetch_object($result)){
	$coll_arr_temp[] = $row->collection_list;
}
...
if($coll_arr_temp){
	...
	$coll_str = implode(",",$coll_arr_temp);
	...
	$sql_coll = "SELECT a.productcode,a.productname,a.sellprice,a.maximage,a.minimage,a.tinyimage,a.etctype,a.reserve,a.reservetype,a.consumerprice,a.option_price,a.tag,a.quantity,a.selfcode 
			...
			<?php if($coll_prd){ ?>
				<div class="goods_right_best_view">
					...
					?>
						<ul>
							<li>
								<a href="<?=$Dir.FrontDir."productdetail.php?productcode=".$v['productcode']?>">
									<img src="<?=$Dir.DataDir."shopimages/product/".$v['tinyimage']?>" alt="" />
								</a>
							</li>
							<li class="name"><?=$v['productname']?></li>
							<li class="price"><?=$v['sellprice']?></li>
						</ul>
					<?php
							}
						}
