...
<tr>
	...
	<tr>
		...
		<tr>
			<td height="28" class="link" align="right"><img src="images/top_link_house.gif" border="0" valign="absmiddle">현재위치 : 디자인관리 &gt; 개별디자인-페이지 본문 &gt; <span class="2depth_select">단골매장 화면 꾸미기</span></td>
		</tr>
		<tr>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				...
				<TR>
					<TD><IMG SRC="images/design_eachmycustsect_title.gif" WIDTH="208" HEIGHT=32 ALT=""></TD>
			...
			<tr>
				...
				<TR>
					...
					<tr>
						...
						<td width="701"><p class="LIPoint"><B><span class="font_orange">단골매장 화면 매크로명령어</span></B>(해당 매크로명령어는 다른 페이지 디자인 작업시 사용이 불가능함)</p></td>
					</tr>
					<tr>
