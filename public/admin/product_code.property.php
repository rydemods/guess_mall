...
?> 
	...
	<tr>
		...
		<TD class="td_con1">
		<!--
		<input type=checkbox id="idx_special1" name=tmp_special value="1" <?php if($special["1"]=="Y")echo"checked";?>> <label style='cursor:hand;' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'" for=idx_special1>신규상품</label>
	...
	<tr>
		...
		<TD class="td_con1">
            <input type=checkbox id="idx_code_hide1" name=up_code_hide value="NO" <?php if($group_code=="NO") echo "checked";?> onclick="GroupCheck(this.checked)"> <label style='cursor:hand;' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'" for=idx_code_hide1>사용 안함</label>
