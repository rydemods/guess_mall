...
<div class="admin_linemap">
	<div class="line">
		<p>
			현재위치 : 환경설정 &gt; 운영 설정 &gt;<span>상품검색 관련 기능설정</span>
		</p>
	</div>
</div>
				...
				<tr>
					<td>
						<table cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed">
							...
							<col width=></col>
							<tr>
								<td valign="top"><?php include("menu_shop.php"); ?></td>
								<td></td>
								<td valign="top">
									<table cellpadding="0" cellspacing="0" width="100%">
										...
										<tr>
											<td>
												<!-- 페이지 타이틀 -->
												<div class="title_depth3">상품검색 관련 기능설정</div>
											</td>
										</tr>
										<tr>
											<td>
												...
												<td>
													<div class="table_style01">
														<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
															<TR>
																<th><span>기본검색어 입력</span></th>
																<TD class="td_con1">
																	<input type=text name=up_defaultkeyword value="<?=$defaultkeyword?>" size=100 onkeyup="check_searchvalidate(event, this);" onblur="check_searchsvalidate(this);" class="input"><br>
																</TD>
															</TR>
														</TABLE>
													</div>
													...
													<div class="table_style01">
														<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
															<TR style="display: none;">
																<th><span>인기검색어 사용여부 선택</span></th>
																<TD class="td_con1"><input type=radio
																	id="idx_bestkeyword1" name=up_bestkeyword value="Y"
																	<?=$check_bestkeywordY?>><label style='cursor: hand;'
																	onmouseover="style.textDecoration='underline'"
																	onmouseout="style.textDecoration='none'"
																	for=idx_bestkeyword1>인기검색어 기능 사용</label>&nbsp;&nbsp;&nbsp;<input
																	type=radio id="idx_bestkeyword2" name=up_bestkeyword
																	value="N" <?=$check_bestkeywordN?>><label
																	style='cursor: hand;'
																	onmouseover="style.textDecoration='underline'"
																	onmouseout="style.textDecoration='none'"
																	for=idx_bestkeyword2>인기검색어 기능 미사용</label><br>
																<span class=font_blue>* 인기검색어는 쇼핑몰의 특정 상품을 노출시키고자 할 경우
																		유용하게 사용됩니다.</span></TD>
															</TR>
															<TR>
																<th><span>노출 인기검색어 입력</span></th>
																<TD class="td_con1"><input type=text name=up_keyword
																	value="<?=$keyword?>" size=100
																	onkeyup="check_searchvalidate(event, this);"
																	onblur="check_searchsvalidate(this);" class="input"><br>
																<span class=font_blue>* 인기검색어 기능을 사용할 경우에만 적용됩니다.
																		(콤마","로 구분하여 등록하세요)</span></TD>
															</TR>
														</TABLE>
													</div>
												</td>
										...
										<tr>
											<td>
												<div class="sub_manual_wrap">
													...
													<div class="ml-20 mb-20"><img src="static/img/common/search_ex.gif" alt="검색설정 예시"></div>
												</div>
											</td>
										</tr>
										<tr>
