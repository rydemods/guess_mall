...
<div class="admin_linemap"><div class="line"><p>현재위치 : 상품관리 &gt; 카테고리/상품관리 &gt;<span>한주간 많이 팔린 상품 진열관리</span></p></div></div>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td>
					<!-- 페이지 타이틀 -->
					<div class="title_depth3">한주간 많이 팔린 상품 진열관리</div>
					<!-- 소제목 -->
					<div class="title_depth3_sub"><span>쇼핑몰 메인페이지에 한주간 많이 팔린 상품을 등록할 수 있습니다.</span></div>
				</td>
			</tr>
			<tr>
				<td>
...
<?php
		...
		?>
							...
							<td valign=top>
								<!-- 소제목 -->
								<div class="title_depth3_sub">한주간 많이 팔린 상품 진열 리스트</div>
								<?
									if($serial_value){
										$iframeSrc = "product_bestlist.main.php?".$serial_value."&autoUri=1";
									}else{
										$iframeSrc = "product_bestlist.main.php";
									}
								?>
