...
<div class="admin_linemap"><div class="line"><p>현재위치 : 디자인관리 &gt; 템플릿-메인, 카테고리 &gt;<span>상품 카테고리 템플릿</span></p></div></div>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td>
					<!-- 페이지 타이틀 -->
					<div class="title_depth3">상품 카테고리 템플릿</div>
				</td>
			</tr>
			<tr>
				<td>
					<!-- 소제목 -->
					<div class="title_depth3_sub"><span>쇼핑몰 카테고리 화면 디자인을 선택하여 사용하실 수 있습니다.</span></div>
				</td>
			</tr>
			<tr>
				<td>
					<!-- 소제목 -->
					<div class="title_depth3_sub">상품 카테고리별 템플릿</div>
				</td>
			</tr>
			...
			<tr>
				<td><IFRAME name="MainPrdtFrame" id="MainPrdtFrame" src="design_plist.list.php" width=100% frameborder=0 align=TOP scrolling="no" marginheight="0" marginwidth="0"></IFRAME></td>
			</tr>
			</form>
			<tr>
				<td height=20></td>
			...
			<tr>
				...
				<div class="sub_manual_wrap">
                    ...
                    <dl>
                        ...
                        <dd>- <a href="javascript:parent.topframe.GoMenu(2,'design_eachplist.php');"><span class="font_blue">디자인관리 > 개별디자인 - 페이지 본문 > 상품 카테고리 꾸미기</span></a> 에서 개별 디자인을 할 수 있습니다<br />- 개별 디자인 사용시 템플릿은 적용되지 않습니다.</dd>
                    </dl>
                    <dl>
