...
Header("Content-Disposition: attachment; filename=order_excel_all_order_".date("Ymd",$CurrentTime).".xls"); 
Header("Pragma: no-cache"); 
Header("Expires: 0");
Header("Cache-Control: must-revalidate, post-check=0,pre-check=0");
Header("Content-Description: PHP4 Generated Data");

//$excel_info = "49,0,35,1,21,6,25,50,28,27,51,10,52";
$excel_info = "49,0,35,1,5,3,4,21,6,25,50,28,27,51,10,52";
