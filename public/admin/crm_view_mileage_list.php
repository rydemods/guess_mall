...
//-->
			...
			<div class="contentsBody">
                ...
                <input type="hidden" name="menu" value="mileage">
				<h3 class="table-title">통합포인트 조회<!-- &nbsp;&nbsp;&nbsp;<button onClick="javascript:ReserveInOut('<?=$mem_id?>')" class="btn-function on" type="button"><span>+ -</span></button> --></h3>
				<table class="th-left">
					<caption>통합포인트 조회</caption>
					<colgroup>
				...
				<table class="th-top">
					<caption>통합포인트 리스트</caption>
					<colgroup>
						<col style="width:60px"><col style="width:100px"><col style="width:auto"><col style="width:100px"><col style="width:100px">
					</colgroup>
					<thead>
						<tr>
							<th scope="row">번호</th>
