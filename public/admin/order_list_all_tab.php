...
<div class="admin_linemap"><div class="line"><p>현재위치 : 주문/매출  &gt; 주문조회 및 배송관리 &gt;<span>단계별 주문 조회</span></p></div></div>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td>
					<!-- 페이지 타이틀 -->
					<div class="title_depth3">단계별 주문 조회 </div>
					<!-- 소제목 -->
            ...
            <tr>
                <td>
                    <div id="tabs-container">
                        <ul class="tabs-menu">
                            <li class="on"><a href="#tab-1" alt="./order_list_all_tab_view.php?oistep1=0">주문접수</a></li>
                            <li><a href="#tab-2" alt="./order_list_all_tab_view.php?oistep1=1">결제완료</a></li>
                            <li><a href="#tab-3" alt="./order_list_all_tab_view.php?oistep1=2">배송준비중</a></li>
                            <li><a href="#tab-4" alt="./order_list_all_tab_view.php?oistep1=3">배송중</a></li>
                            <li><a href="#tab-5" alt="./order_list_all_tab_view.php?oistep1=4">배송완료</a></li>
                        </ul>
                        <div class="tab-content-wrap">
                            <div id="tab-1" class="tab-content"><iframe src="./order_list_all_tab_view.php?oistep1=0" width="100%" height="800" frameborder=0 scrolling="auto"></iframe></div>
                            <div id="tab-2" class="tab-content"><iframe src="./order_list_all_tab_view.php?oistep1=1" width="100%" height="800" frameborder=0 scrolling="auto"></iframe></div>
                            <div id="tab-3" class="tab-content"><iframe src="./order_list_all_tab_view.php?oistep1=2" width="100%" height="800" frameborder=0 scrolling="auto"></iframe></div>
                            <div id="tab-4" class="tab-content"><iframe src="./order_list_all_tab_view.php?oistep1=3" width="100%" height="800" frameborder=0 scrolling="auto"></iframe></div>
                            <div id="tab-5" class="tab-content"><iframe src="./order_list_all_tab_view.php?oistep1=4" width="100%" height="800" frameborder=0 scrolling="auto"></iframe></div>
                        </div>
                    </div>
                </td>
            </tr>
