...
function Result() {
	try {
		if(document.form1.up_brandlist.selectedIndex>-1) {
			opener.document.form2.bridx.value=document.form1.up_brandlist.options[document.form1.up_brandlist.selectedIndex].value;
			opener.document.form2.brandname.value=document.form1.up_brandlist.options[document.form1.up_brandlist.selectedIndex].text;
			window.close();
		} else {
