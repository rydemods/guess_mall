...
function DownloadExcel() {
    //alert("excel");
	document.form1.action="member_staff_point_list_excel.php";
...
<div class="admin_linemap"><div class="line"><p>현재위치 : 회원관리 &gt; 회원관리 부가기능 &gt;<span>임직원 마일리지 지급 리스트</span></p></div></div>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td>
					<!-- 페이지 타이틀 -->
					<div class="title_depth3">임직원 마일리지 지급 리스트</div>
					<!-- 소제목 -->
					<div class="title_depth3_sub"><span>임직원 마일리지 지급 내역을 확인하실 수 있습니다.</span></div>
				</td>
			</tr>
			...
			<tr>
				<td>
					<!-- 소제목 -->
					<div class="title_depth3_sub">임직원 마일리지 현황 조회</span></div>
				</td>
			</tr>
			...
			<tr>
				...
				<!-- 매뉴얼 -->
					<div class="sub_manual_wrap">
						...
						<dl>
							<dt><span>임직원 마일리지 지급 리스트</span></dt>
							<dd>
							</dd>
						</dl>
					</div>
