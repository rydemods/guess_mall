...
function MainInsert(prcode,chk) {//체크박스로 호출됬을때 동작 체크chk
	max=50;
...
<div class="admin_linemap"><div class="line"><p>현재위치 : 상품관리 &gt; 카테고리/상품관리 &gt;<span>메인상품 진열관리</span></p></div></div>
		...
		<tr>
			...
			<tr>
				...
				<?php
									...
									echo "<tr>";
									echo "<td><input type='checkbox' class='chk_list' value=".$row->productcode."></td>";//체크박스 추가 20150604원재
									echo "<td>".$number."</td>";
									if($vendercnt>0) {
...
<?php
		...
		?>
							...
							<td valign=top>
								<!-- 소제목 -->
								<div class="title_depth3_sub">모바일 진열 리스트</div>
								<?
									if($serial_value){
										$iframeSrc = "product_mobile.main.php?".$serial_value."&autoUri=1";
									}else{
										$iframeSrc = "product_mobile.main.php";
									}
								?>
