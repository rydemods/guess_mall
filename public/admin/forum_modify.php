...
<TR>
	...
	<tr>
		...
		<tr>
			...
			<TR>
				<th><span>공지글 등록</span></th>
				<TD class="td_con1"><input type="checkbox" value="Y" name="chk_notice" <?if($view_detail->notice=='Y'){echo "checked";}?>>*체크시 공지글로 노출됩니다</TD>
			</TR>
			...
			<TR>
				...
				<TD class="td_con1">
                    <B><?=$view_detail->id?></B>
                    &nbsp;=> <input type=text name="modi_id" value="" class="input">
                </TD>
			</TR>
			<TR>
				<th><span>날짜</span></th>
				<TD class="td_con1">
                    <B><?=date("Y-m-d H:i:s",strtotime($view_detail->writetime) )?></B>
                    &nbsp;=> <input type=text name="modi_date" value="" class="input" maxlength=14> (수기변경시 20161021183947 과 같이 입력해주세요.)
                </TD>
			</TR>
		
			<TR>
				<th><span>말머리</span></th>
				<TD class="td_con1"><input name="summary" value="<?=$view_detail->summary?>" style="width:90%;" class="input"></TD>
			</TR>

			<TR>
				<th><span>제목</span></th>
				<TD class="td_con1"><input name="title" value="<?=$view_detail->title?>" style="width:90%;" class="input"></TD>
			</TR>
			...
			<TR>
				<th><span>태그</span></th>
				<TD class="td_con1"><input type="text" name="hash_tags" value="<?=$view_detail->tag?>" class="input"></textarea></TD>
			</TR>
...
{
    var modi_date = document.forum_write_form.modi_date.value;
