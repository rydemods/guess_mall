...
?>
			...
			<TR align="center">
				...
				<TD class="table_cell1" style="font-size:11px;">상세</TD>
			</TR>
<?php
		$page_numberic_type=1;
		if ($code) $qry= "AND productcode LIKE '{$code}%' ";
		if ($keyword) $qry.= "AND productname LIKE '%{$keyword}%' ";
...
?>
					...
					<TD class="td_con1"><a href="javascript:ProductInfo('<?=$row->productcode?>');"><img src="images/icon_newwin1.gif" border="0"></a></td>
				</tr>
