...
if($mode=="update" && ord($design) && strlen($code)==12 && $code!="000000000000") {
	...
	if($is_design=="1") {
		...
		$sql.= "AND code_b='{$code_b}' AND code_d='{$code_d}' ";
	}
...
<tr>
	...
	<TR>
		<TD><IMG <?php if($sch=="AL")echo"SRC=\"images/img_tapstart.gif\""; else echo"SRC=\"images/img_tapstartr.gif\"";?> ALT=""></TD>
		<TD width="202" <?php if($sch=="AL")echo"background=\"images/img_tapbg.gif\" class=\"font_white\""; else echo"background=\"images/img_tapbgr.gif\"";?>><input type=radio id="idx_sch0" name="sch" value="AL" <?php if($sch=="AL")echo"checked";?> onclick="SkinList()"> <label style='cursor:hand; TEXT-DECORATION: none;' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'" for=idx_sch0>일반 쇼핑몰 디자인 타입</label></TD>
		<TD><IMG <?php if($sch=="AL")echo"SRC=\"images/img_tap_end.gif\""; else echo"SRC=\"images/img_tap_endr.gif\"";?> ALT=""></TD>
		<TD><IMG <?php if($sch=="BL")echo"SRC=\"images/img_tapstart.gif\""; else echo"SRC=\"images/img_tapstartr.gif\"";?> ALT=""></TD>
		<TD width="202" <?php if($sch=="BL")echo"background=\"images/img_tapbg.gif\" class=\"font_white\""; else echo"background=\"images/img_tapbgr.gif\"";?>><input type=radio id="idx_sch1" name="sch" value="BL" <?php if($sch=="BL")echo"checked";?> onclick="SkinList()"> <label style='cursor:hand; TEXT-DECORATION: none;' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'" for=idx_sch1>가격 고정형 디자인 타입</label></TD>
		<TD><IMG <?php if($sch=="BL")echo"SRC=\"images/img_tap_end.gif\""; else echo"SRC=\"images/img_tap_endr.gif\"";?> ALT=""></TD>
	</TR>
	</TABLE>
	</TD>
</tr>
