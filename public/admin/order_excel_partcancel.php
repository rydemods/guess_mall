...
Header("Content-Disposition: attachment; filename=order_partcancel_excel_".date("Ymd",$CurrentTime).".xls"); 
...
if($isproduct=="Y" || $isproductall=="Y") {
	...
	$sql.= "JOIN tblorderproductcancel b ON b.ordercode=a.ordercode ";
