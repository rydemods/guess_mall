...
<div class="admin_linemap"><div class="line"><p>현재위치 : 회원관리 &gt; 회원관리 부가기능 &gt;<span>회원 로그인 리스트</span></p></div></div>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td>
					<!-- 페이지 타이틀 -->
					<div class="title_depth3">회원 로그인 리스트</div>
					<!-- 소제목 -->
					<div class="title_depth3_sub"><span>회원 로그인 내역을 확인하실 수 있습니다.</span></div>
				</td>
			</tr>
				...
				<td>
					...
					<tr>
                        ...
                        <TR>
							<th><span>접속경로</span></th>
							<TD class="td_con1">
                                <input type="checkbox" name="ord_flag[]" value="web" <?=(in_array('web',$access_arr)?'checked':'')?>>PC</input>
                                <input type="checkbox" name="ord_flag[]" value="mobile" <?=(in_array('mobile',$access_arr)?'checked':'')?>>MOBILE</input>
                                <input type="checkbox" name="ord_flag[]" value="app" <?=(in_array('app',$access_arr)?'checked':'')?>>APP</input>
                            </TD>
						</TR>
