...
if($type=="update") {
	...
	$onload="<script>window.onload=function(){alert(\"상품검색 결과화면 템플릿 설정이 완료되었습니다.\");}</script>";
}
include("header.php"); 
?>
...
<!-- 라인맵 -->
<div class="admin_linemap"><div class="line"><p>현재위치 : 디자인관리 &gt; 템플릿-페이지 본문 &gt;<span>상품검색 화면 템플릿</span></p></div></div>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td>
					<!-- 타이틀 -->
					<div class="title_depth3">상품검색 화면 템플릿</div>
					<div class="title_depth3_sub"><span>상품검색 결과화면 디자인을 선택하여 사용하실 수 있습니다.</span></div>
                </td>
            </tr>
            <tr>
            	<td>
			...
			<tr>
				<td align=center><img id="preview_img" src="images/sample/search<?=$_shopdata->design_search?>.gif" border=0 class="imgline"></td>
			</tr>
			<tr>
				<td height="20"></td>
			</tr>
...
<?php
		for($i=0;$i<count($templet_list);$i++) {
			...
			echo "<img src=\"images/sample/search{$templet_list[$i]}.gif\" border=\"0\" class=\"imgline1\" onMouseOver='changeMouseOver(this);' onMouseOut=\"changeMouseOut(this,'dotted #FFFFFF');\" style='cursor:hand;' onclick='ChangeDesign({$i});'>";
			...
			<tr>
				...
				<div class="sub_manual_wrap">
					...
					<dl>
						...
						<dd>- <a href="javascript:parent.topframe.GoMenu(2,'design_eachsearch.php');"><span class="font_blue">디자인관리 > 개별디자인 - 페이지 본문 > 상품검색 결과화면 꾸미기</span></a> 에서 개별 디자인을 할 수 있습니다.<br />- 개별 디자인 사용시 템플릿 적용되지 않습니다.						</dd>
					</dl>
					<dl>
