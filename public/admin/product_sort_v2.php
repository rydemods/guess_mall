						...
						<td width="100%" height="100%" valign="top" bgcolor="#FFFFFF" style="padding-left:5px;padding-right:5px;">
							...
							<?php
									...
									if(strlen($code)==12) {
                                        ...
                                        $sql.= $qry." ";
                                        $sql.= "ORDER BY start_no asc, modifydate desc  ";
                                        ...
                                        if($cnt>0)
                                        {
                                            ...
                                            while($row=pmysql_fetch_object($result)) {
                                                ...
                                                echo "	<TABLE border=\"0\" cellSpacing=\"0\" cellPadding=\"0\" width=\"100%\" style=\"table-layout:fixed;\" onclick=\"ChangeList('{$j}');focusOut();\">\n";
