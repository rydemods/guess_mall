...
<script language="JavaScript">
	...
	function getSabangCode(val){
		if(!$("input[name='search_start']").val() && !$("input[name='search_end']").val()){
			...
			if(val == 'o'){
				$("input[name='mode']").val("sabangOrderGet");
				//document.form1.submit();
			}else{
				$("input[name='mode']").val("sabangClameGet");
			}
			$.ajax({
				type: "POST", 
				...
				beforeSend: function () {
					popupJquery('sabangnet_process_popup.php', 647, 200);
				}
			}).done(function ( data ) {
					...
					<td>
						<table cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed">
							...
							<tr>
								...
								<td valign="top">
									<form name=form1 action="sabangnet_indb.php" method=post enctype="multipart/form-data">
										...
										<table cellpadding="0" cellspacing="0" width="100%">
											...
											<tr>
												<td align="center">
													<p>
														<a href="javascript:getSabangCode('o');">[주문 수집]</a>&nbsp;&nbsp;
														<a href="javascript:getSabangCode('c');">[클레임 수집]</a>
													</p>
												</td>
											</tr>
											<tr>
