...
if(ord($search)) {
	...
	if($s_check=="all") $qry.= "AND a.ordercode||a.sender_name||a.id||a.receiver_name like '%{$search}%' ";
	...
	else if($s_check=="bn") $qry.= "AND a.bank_sender='{$search}' ";
}
...
WHERE ((SUBSTR(a.paymethod,1,1) IN ('B','O','Q') AND LENGTH(a.bank_date)=9) OR (SUBSTR(a.paymethod,1,1) IN ('C','P','M','V') AND a.pay_flag='0000' AND a.pay_admin_proc='C'))
{$check_qry}"));
?>
<style>
	.crmView{
...
function searchForm() {
	...
	document.form1.action="order_list2.php";
		...
		if(form.ord_chg.value!=''){
			...
			if(confirm("주문 단계를 변경할까요?")){
				...
				if(num==0){
					...
					form.action="order_chg_indb2.php?ordcode="+ordcode;
					form.submit();
				}
			}
		}else{
...
?>
			...
			<tr>
				<td style="padding-top:4pt;" align="right"><a href="javascript:searchForm();"><img src="images/botteon_search.gif"  border="0"></a>&nbsp;<a href="javascript:OrderExcel();"><img src="images/btn_excel1.gif"  border="0" hspace="1"></a>&nbsp;<a href="javascript:AddressPrint();"><img src="images/btn_adress.gif"  border="0"></a></td>
			</tr>
			</form>
			<tr>
				<td height="20"></td>
...
?>
		<div class="table_style02">
			...
			?>
			<tr>
				<td colspan = '12' style = 'text-align:right;padding:15px 5px 15px 5px;;'>
...
?>
			...
			<tr>
				<td style="padding-top:4pt;"><a href="javascript:OrderDeliPrint();"><img src="images/btn_print.gif"  border="0" hspace="1"></a>&nbsp;<a href="javascript:OrderCheckPrint();"><img src="images/btn_juprint.gif"  border="0" hspace="0"></a>&nbsp;<a href="javascript:OrderCheckExcel();"><img src="images/btn_excel1.gif"  border="0" hspace="1"></a>&nbsp;<a href="javascript:OrderCheckDelete();"><img src="images/btn_judel.gif"  border="0"></a></td>
			</tr>
			<!--tr>
				<td align="center">
				<table cellpadding="0" cellspacing="0" width="100%">
