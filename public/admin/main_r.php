...
function ProductInfo(code,prcode,popup) {
	...
	if (popup=="YES") {
		...
		document.prform.action="product_register.add.php";
	} else {
...
?>
			...
			<tr>
				...
				<tr>
					<td>
						...
						<table width="183" border="0" cellspacing="0" cellpadding="0" align="center">
						<tr>
							<td><?=(setUseVender()?"<a href=\"vender_new.php\">":"<a href=\"javascript:not_vender_alert();\">")?>&bull; 입점업체 등록</a></td>
						</tr>
						<tr>
							<td><?=(setUseVender()?"<a href=\"vender_management.php\">":"<a href=\"javascript:not_vender_alert();\">")?>&bull; 입점업체 관리</a></td>
						</tr>
						<tr>
			...
			<!-- left 배너 추가 -->
			<div class="left_bn_area"><img src="img/common/left_add_banner.gif" alt="" /></div>
...
?>
			...
			<tr>
				...
				<tr>
					...
					<tr>
						<td>
						<div class="orderlist_tit"><p><a href="#"><img src="img/icon/icon_reload.gif" alt="새로고침" /></a> <a href="javascript:parent.topframe.GoMenu(5,'order_list.php');"><img src="img/icon/icon_more.gif" alt="더보기" /></a><div class="icon"></p></div></div>
						</td>
					</tr>
					<tr>
						<td height=10></td>
...
<?php
							...
							ORDER BY duedate, duetime ASC LIMIT 6 ";
							$result = pmysql_query($sql,get_db_conn());
							while($row=pmysql_fetch_object($result)) {
								...
								echo "	<td align=center><A HREF=\"community_schedule_day.php?year=".$y."&month=".$m."&day=".$d."\"><font class={$fontclass}>[".$m."-".$d."]</font> <font class={$fontclass}>".titleCut(15,$row->subject)."</font></A></td>\n";
								echo "</tr>\n";
							}
							pmysql_free_result($result);
?>
						...
						<table>
							...
							<tr valign=top>
								<td align=center height="141">
									...
									<?php
									$sql = "SELECT idx, subject, re_date FROM tblpersonal
									ORDER BY idx DESC LIMIT 6 ";
									$result=pmysql_query($sql,get_db_conn());
									$i=0;
									while($row=pmysql_fetch_object($result)) {
										echo "<tr>\n";
									...
									<?php
									$sql = "SELECT title, num FROM tblboard WHERE board='qna'
...
?>
			...
			<div class="right_banner_wrap">
				<table border="0" cellspacing="0" cellpadding="0" width=203>
					...
					<tr><td><a href="#"><img src="img/common/right_bn03.gif" alt="" /></a></td></tr>
					<tr><td><a href="#"><img src="img/common/right_bn04.gif" alt="" /></a></td></tr>
					<tr><td><a href="#"><img src="img/common/right_bn05.gif" alt="" /></a></td></tr>
					<tr><td><a href="#"><img src="img/common/right_bn06.gif" alt="" /></a></td></tr>
				</table>
			</div>
