...
<div class="admin_linemap"><div class="line"><p>현재위치 : 상품관리 &gt; 카테고리/상품관리 &gt;<span>이슈 상품 진열관리</span></p></div></div>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td>
					<!-- 페이지 타이틀 -->
					<div class="title_depth3">이슈상품 진열관리</div>
					<!-- 소제목 -->
...
<?php					
		...
		?>
							...
							<td valign=top>
								<!-- 소제목 -->
								<div class="title_depth3_sub">이슈 진열 리스트</div>
								
								<IFRAME name="MainPrdtFrame" src="product_issuelist.main.php" width=100% height=100% frameborder=0 align=TOP scrolling="no" marginheight="0" marginwidth="0"></IFRAME>
								<!--
