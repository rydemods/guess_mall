				...
				<td>				
					...
					<table width="100%" cellspacing=0 cellpadding=0 border=0>
						...
						<td align=left style="padding-left:30px;">
							<DIV style="width:100%;height:100%;bgcolor:#FFFFFF;"><IFRAME name="PropertyFrame" src="product_code.property.php" width=100% height=1000 frameborder=0 align=TOP scrolling="no" marginheight="0" marginwidth="0"></IFRAME></div>
							<!-- 매뉴얼 -->
