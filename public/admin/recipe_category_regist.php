...
<tr>
	<td width="100%" bgcolor="#FFFFFF">
		...
		<!-- 소제목 -->
		<div class="title_depth3_sub">카테고리 속성<span>카테고리 추가, 수정, 삭제가 가능합니다.</span></div>
...
<tr>
	...
	<input type="text" name="module" value="recipe_category">
	<input type="text" name="mode" value="write">
	...
	<TR>
		...
		<TD class="td_con1"><input type=text name="name" size=38 maxlength=100 value="<?=htmlspecialchars($name)?>" class="input_selected" style="width:100%"></TD>
	</TR>
	<!--
	<TR>
		<th><span>카테고리명</span></th>
	...
	<input type="image" src="images/botteon_add.gif"  border="0" hspace="0">
	</div>
	</form>
	<!-- 컨텐츠 종료 -->
    </div>
