...
<div class="admin_linemap"><div class="line"><p>현재위치 : 디자인관리 &gt; 템플릿-페이지 본문 &gt;<span>상품브랜드 화면 템플릿</span></p></div></div>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td>
					<!-- 페이지 타이틀 -->
					<div class="title_depth3">상품브랜드 화면 템플릿</div>
                    <div class="title_depth3_sub"><span>상품 브랜드별 화면 디자인을 선택하여 사용하실 수 있습니다.</span></div>
				</td>
			</tr>
			<tr>
				<td>
					<!-- 소제목 -->
					<div class="title_depth3_sub">상품브랜드별 화면 템플릿</div>
				</td>
			</tr>
			<tr>
				<td height=3></td>
				...
				<TR>
					...
					<?php
						...
						if(preg_match("/^[ㄱ-ㅎ]/", $seachIdx)) {
							...
							$sql.= "ORDER BY brandname ";
						} elseif(preg_match("/^[A-Z]/", $seachIdx)) {
			...
			<tr>
				<td><IFRAME name="MainPrdtFrame" id="MainPrdtFrame" src="design_blist.list.php" width=100% height=350 frameborder=0 align=TOP scrolling="no" marginheight="0" marginwidth="0"></IFRAME></td>
			</tr>
			</form>
			<tr>
				<td height=20></td>
			...
			<tr>
				...
				<div class="sub_manual_wrap">
					...
					<dl>
                      ...
                      <dd>- 상품 브랜드 페이지 노출 설정은 <a href="javascript:parent.topframe.GoMenu(4,'product_brand.php');"><span class="font_blue">상품관리 > 카테고리/상품관리 > 상품 브랜드 설정 관리</span></a> 에서 설정해 주세요.<br />- 템플릿 디자인 일괄 적용은 해당 브랜드의 템플릿이 일괄적으로 변경 됩니다.</dd>
                    </dl>
                    <dl>
                    	<dt><span>개별 디자인</span></dt>
                        <dd>- <a href="javascript:parent.topframe.GoMenu(4,'design_eachblist.php');"><span class="font_blue">디자인관리 > 개별디자인 - 페이지 본문 > 상품 브랜드 꾸미기</span></a> 에서 개별 디자인을 할 수 있습니다.<br />- 개별 디자인 사용시 템플릿은 적용되지 않습니다.</dd>
                    </dl>
                    <dl>
                    ...
                    <dl>
                        ...
                        <dd>- <a href="javascript:parent.topframe.GoMenu(7,'market_eventbrand.php');"><span class="font_blue">마케팅지원 > 이벤트/사은품 기능 설정 > 브랜드별 이벤트 관리</span></a> 에서 각각 이벤트 관리를 할 수 있습니다.<br />- 브랜드별 이벤트는 템플릿 사용할 경우에만 작동 됩니다.</dd>
                    </dl>
                </div>
                </td>
			</tr>
