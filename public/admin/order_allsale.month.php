...
**/
$sql = "SELECT ";
//$sql.= "COUNT(CASE WHEN a.deli_gbn='Y' THEN 1 ELSE NULL END) as ycnt, ";                        // 배송
//$sql.= "COUNT(CASE WHEN a.deli_gbn='N' OR a.deli_gbn='S' THEN 1 ELSE NULL END) as ncnt, ";      // 미처리 
//$sql.= "COUNT(CASE WHEN a.deli_gbn='R' THEN 1 ELSE NULL END) as rcnt, ";                        // 반송
//$sql.= "SUM(CASE WHEN a.deli_gbn ='Y' THEN a.price ELSE NULL END) as ysum, ";                   // 배송
//$sql.= "SUM(CASE WHEN a.deli_gbn ='N' OR a.deli_gbn='S' THEN a.price ELSE NULL END) as nsum, "; // 미처리
//$sql.= "SUM(CASE WHEN a.deli_gbn ='R' THEN a.price ELSE NULL END) as rsum, ";                   // 반송
$sql.= "COUNT(CASE WHEN a.deli_gbn='Y' THEN 1 ELSE NULL END) as ycnt, ";                        // 배송
...
$sql.= "COUNT(CASE WHEN a.deli_gbn='R' THEN 1 ELSE NULL END) as rcnt, ";                        // 반송
$sql.= "SUM(CASE WHEN a.deli_gbn ='Y' THEN a.price-a.dc_price::int-a.reserve+a.deli_price ELSE NULL END) as ysum, ";                   // 배송
...
$sql.= "SUM(CASE WHEN a.deli_gbn ='R' THEN a.price-a.dc_price::int-a.reserve+a.deli_price ELSE NULL END) as rsum, ";                   // 반송
$sql.= "SUBSTR(a.ordercode,1,8) as day FROM tblorderinfo a ";
