...
.tabs-menu {}
	...
	.tabs-menu li {float:left; position:relative; width:33.3%; height: 31px;line-height: 31px;float: left;background-color: #f0f0f0; box-sizing:border-box; border:1px solid #d3d3d3; border-bottom:1px solid #4b4b4b;}
...
<div class="admin_linemap"><div class="line"><p>현재위치 : 주문/매출  &gt; 주문조회 및 배송관리 &gt; <span>교환관리</span></p></div></div>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td>
					<!-- 페이지 타이틀 -->
					<div class="title_depth3">교환관리</div>
					<!-- 소제목 -->
					<div class="title_depth3_sub"><span>교환 내역을 확인/처리하실 수 있습니다.</span></div>
				</td>
			</tr>
            ...
            <tr>
                <td>
                    <div id="tabs-container">
                        <ul class="tabs-menu">
                            <li class="on"><a href="#tab-1" alt='./order_list_cancel_step34_change_view.php?opstep=40'>교환신청</a></li>
                            <li><a href="#tab-2" alt='./order_list_cancel_step34_change_view.php?opstep=41'>교환접수</a></li>
                            <li><a href="#tab-3" alt='./order_list_cancel_step44_view.php?oistep=342'>교환완료</a></li>
                        </ul>
                        <div class="tab-content-wrap">
                            <div id="tab-1" class="tab-content"><iframe src="./order_list_cancel_step34_change_view.php?opstep=40" width="100%" height="800" frameborder=0 scrolling="auto"></iframe></div>
                            <div id="tab-2" class="tab-content"><iframe src="./order_list_cancel_step34_change_view.php?opstep=41" width="100%" height="800" frameborder=0 scrolling="auto"></iframe></div>
                            <div id="tab-3" class="tab-content"><iframe src="./order_list_cancel_step44_view.php?oistep=342" width="100%" height="800" frameborder=0 scrolling="auto"></iframe></div>
                        </div>
                    </div>
                </td>
            </tr>
