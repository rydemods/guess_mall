...
include($Dir."lib/soap.file.class.php");
include($Dir."lib/recipe.class.php");

$sfile = new SOAP_FILES();
...
<div class="admin_linemap"><div class="line"><p>현재위치 : 커뮤니티 &gt; 레시피 관리 &gt;<span>레시피 컨텐츠 관리</span></p></div></div>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td>
					<!-- 페이지 타이틀 -->
					<div class="title_depth3">레시피 관리</div>
					<!-- 소제목 -->
					<div class="title_depth3_sub"><span>레시피를 관리할 수 있습니다.</span></div>
				</td>
			</tr>
			<tr>
				<td>
				...
				include("recipe_article.{$exec}.inc.php")
				?>
				</td>
			</tr>
