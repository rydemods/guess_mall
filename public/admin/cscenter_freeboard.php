...
if($_REQUEST["mode"]=="comment_result") {
	...
	header("Location:{$_SERVER['PHP_SELF']}?exec=view&num=$num&block=$block&gotopage=$gotopage&search=$search&s_check=$s_check");
	exit;
...
<div class="admin_linemap"><div class="line"><p>현재위치 : CS관리 &gt; 게시판 ><span><?=$board_name?>게시판</span></p></div></div>
