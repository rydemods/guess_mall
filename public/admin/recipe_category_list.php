...
#########################################################
$catelist =new CATEGORYRECIPELIST();
...
function CodeDelete2(_code) {
	if(_code.length==12 && _code!="000000000000") {
		...
		document.form1.action="recipe_category_regist..php";
			...
			<tr>
				<td>				
					...
					<table width="100%" cellspacing=0 cellpadding=0 border=0>
						...
						<? echo $catelist->getCateTree();?>
							<DIV style="width:100%;height:100%;bgcolor:#FFFFFF;"><IFRAME name="PropertyFrame" src="recipe_category_regist.php" width=100% height=1000 frameborder=0 align=TOP scrolling="no" marginheight="0" marginwidth="0"></IFRAME></div>
							<!-- 매뉴얼 -->
