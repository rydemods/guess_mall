...
if ($termday>31) {
	alert_go('미배송/미입금 주문조회 기간은 1달을 초과할 수 없습니다.');
}
...
<div class="admin_linemap"><div class="line"><p>현재위치 : 주문/매출 &gt; 주문조회 및 배송관리 &gt;<span>미배송/미입금 주문관리</span></p></div></div>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td>
					<!-- 페이지 타이틀 -->
					<div class="title_depth3">미배송/미입금 주문관리</div>
					<!-- 소제목 -->
					<div class="title_depth3_sub"><span>미배송/미입금 처리된 주문 관리를 하실 수 있습니다.</span></div>
				</td>
			</tr>		
			<tr>
				<td>
...
?>
			...
			<tr>
				...
				<col width=40>
                <col width=80>
                <col width=100><?php if($vendercnt>0){?>
                <col width=60><?php }?>
                <col width=>
               <!-- <col width=40>
                <col width=80>
			...
			<tr>
				...
				<!-- 매뉴얼 -->
					<div class="sub_manual_wrap">
						...
						<dl>
							<dt><span>미배송/미입금 주문관리</span></dt>
							<dd>
								- 미배송/미입금 처리된 주문 관리를 하실 수 있습니다.<br>
						...
						<dl>
							<dt><span>미배송/미입금 주문관리 부가기능</span></dt>
							<dd>
						...
						<b>&nbsp;&nbsp;</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;매크로를 사용하여 구매고객의 이름으로 SMS가 발송도 가능합니다. 예) [NAME] ====> 고객님<br>

							</dd>
						</dl>
						<dl>
							<dt><span>미배송/미입금 주문관리 주의사항</span></dt>
							<dd>- 미배송/미입금 주문조회 기간은 1달을 초과할 수 없습니다.</dd>
						</dl>
					</div>
				</td>
			</tr>
