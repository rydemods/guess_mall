    ...
    <td width=100%>
		...
		<div id="crm-wrap">
			...
			<div class="crm-header">
				<a href="#" class="logo"><img src="img/common/admin_logo.gif" border="0"></a>
		...
		<div id="crm-container">
			...
			<div class="lnb-wrap">
				<p class="name">채희영(gmldud726)<a href="#">M</a></p>
				<div class="inner">
					<div class="quick-message">
						<p class="grade">등급 : <strong>일반회원</strong></p>
						<ul class="mrk-icon">
							<li><a href="#"><img src="static/img/icon/icon_marketing_phone.gif" alt=""></a></li>
							<li><a href="#"><img src="static/img/icon/icon_marketing_mail.gif" alt=""></a></li>
							<li><a href="#"><img src="static/img/icon/icon_marketing_memo.gif" alt=""></a></li>
						</ul>
					</div>
					<ul class="visit-date">
						<li>최종방문일 : 2016-02-19</li>
						<li>가입일 : 2016-02-19</li>
					</ul>
					<ul class="nav-menu">
						<li class="on"><a href="#">CRM홈</a></li>
						<li><a href="#">회원상세정보</a></li>
						<li><a href="#">주문내역</a></li>
						<li><a href="#">게시글 정보</a></li>
						<li><a href="#">적립금/예치금/쿠폰</a></li>
						<li><a href="#">장바구니 정보</a></li>
						<li><a href="#">관심상품 정보</a></li>
						<li><a href="#">SMS 발송내역</a></li>
						<li><a href="#">로그인 로그</a></li>
						<li><a href="#">회원 메모</a></li>
						<li><a href="#">전화상담 메모</a></li>
					</ul>
					<dl class="quick-info-box">
						<dt>주문정보</dt>
						<dd>총 주문금액<strong>39,000</strong></dd>
						<dd>총 실결제금액<strong>33,100</strong></dd>
						<dd>누적 주문건수<strong>1</strong></dd>
						<dd>최소 품목수<strong>0</strong></dd>
					</dl>
					<dl class="quick-info-box">
						<dt>상담</dt>
						<dd>게시물<strong>39,000</strong></dd>
					</dl>
					<dl class="quick-info-box">
						<dt>예치금/적립금/쿠폰</dt>
						<dd>예치금<strong>0</strong></dd>
						<dd>적립금<strong>0</strong></dd>
						<dd>쿠폰<strong>1</strong></dd>
					</dl>
				</div>
			</div><!-- //.lnb-wrap -->
