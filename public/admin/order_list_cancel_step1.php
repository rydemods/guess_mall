...
<div class="admin_linemap"><div class="line"><p>현재위치 : 주문/매출  &gt; 주문조회 및 배송관리 &gt; <span>취소관리(결제취소)</span></p></div></div>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td>
					<!-- 페이지 타이틀 -->
					<div class="title_depth3">취소관리(결제취소)</div>
					<!-- 소제목 -->
					<div class="title_depth3_sub"><span>(배송전)결제 취소 내역을 확인/처리하실 수 있습니다.</span></div>
				</td>
			</tr>
            ...
            <tr>
                <td>
                    <div id="tabs-container">
                        <ul class="tabs-menu">
                            <li class="on"><a href="#tab-1" alt="./order_list_cancel_step41_view.php?oistep=2">취소접수(환불접수)</a></li>
                            <li><a href="#tab-2" alt="./order_list_cancel_step44_view.php?oistep=2">환불완료</a></li>
                        </ul>
                        <div class="tab-content-wrap">
                            <div id="tab-1" class="tab-content"><iframe src="./order_list_cancel_step41_view.php?oistep=2" width="100%" height="800" frameborder=0 scrolling="auto"></iframe></div>
                            <div id="tab-2" class="tab-content"><iframe src="./order_list_cancel_step44_view.php?oistep=2" width="100%" height="800" frameborder=0 scrolling="auto"></iframe></div>
                        </div>
                    </div>
                </td>
            </tr>
