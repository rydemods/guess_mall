...
//-->
			...
			<div class="contentsBody">
                ...
                <input type="hidden" name="menu" value="mileage_staff">
				<h3 class="table-title">임직원적립금 조회</h3>
				<table class="th-left">
					<caption>임직원적립금 조회</caption>
					<colgroup>
