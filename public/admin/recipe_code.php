...
include_once($Dir."lib/category.recipe.class.php");
include("access.php");
...
function CodeDelete2(_code) {
	if(_code.length==12 && _code!="000000000000") {
		...
		document.form1.action="recipe_code.process.php";
...
<!-- 라인맵 -->
<div class="admin_linemap"><div class="line"><p>현재위치 : 커뮤니티 &gt; 레시피 관리 &gt; <span>레시피 카테고리 관리</span></p></div></div>
...
<tr>
	...
	<tr>
		...
		<tr>
			...
			<td></td>
			<td valign="top">
			<form name=form1 action="recipe_code_indb.php" method=post>
			<table cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed">
				...
				<td>				
					...
					<table width="100%" cellspacing=0 cellpadding=0 border=0>
						...
						<td align=left style="padding-left:30px;">
							<DIV style="width:100%;height:100%;bgcolor:#FFFFFF;"><IFRAME name="PropertyFrame" src="recipe_code.property.php" width=100% height=1000 frameborder=0 align=TOP scrolling="no" marginheight="0" marginwidth="0"></IFRAME></div>
							<!-- 매뉴얼 -->
								...
								<!--dl>
									...
									<dd>
										  - [상품 등록/수정날짜 순서] : 정렬순서는 최근 수정된 상품이 먼저 출력되며 수정안된 상품은 등록순으로 출력됩니다.   <br />
										    &nbsp;&nbsp;<a href="javascript:parent.topframe.GoMenu(4,'recipe_sort.php');">상품관리 > 카테고리/상품관리 > 상품 진열순서 설정</a> 에서 진열 순서 조절이 가능합니다. <br />
...
<?/*?>			
			...
			<tr>
				...
				<tr>
					...
					<td width="100%" valign="top" height="100%" onmouseover="divAction(document.getElementById('cateidx'),0);"><DIV style="position:relative;z-index:1;width:100%;height:100%;bgcolor:#FFFFFF;"><IFRAME name="PropertyFrame" src="recipe_code.property.php" width=100% height=840 frameborder=0 align=TOP scrolling="no" marginheight="0" marginwidth="0"></IFRAME></div></td>
				</tr>
				<IFRAME name="HiddenFrame" src="<?=$Dir?>blank.php" width=0 height=0 frameborder=0 align=TOP scrolling="no" marginheight="0" marginwidth="0"></IFRAME>
				</table>
				</td>
...
function openTree(obj, chkable)
{
	...
	document.form1.action="recipe_code.property.php";
	document.form1.target="PropertyFrame";
	document.form1.submit();

	//PropertyFrame.location.href = "recipe_code.property.php?mode=modify&code="+cate;
