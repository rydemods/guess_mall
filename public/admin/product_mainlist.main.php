...
<input type="hidden" name="delIdx" >
	<div class="main_view_setup_wrap" style="margin-top:15px;">
		<div class="group">
			...
			<label style='cursor:hand; TEXT-DECORATION: none' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'" for=idx_special1 class="font_d12">Best Sellers</label>&nbsp;&nbsp;&nbsp;
			...
			<label style='cursor:hand; TEXT-DECORATION: none' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'" for=idx_special3 class="font_d12">New Arrivals</label>&nbsp;&nbsp;&nbsp;
		</div>
