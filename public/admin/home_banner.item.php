...
<script language="JavaScript">
	...
	$(document).ready(function(){
		$("body").removeClass('bg');
		document.formList.target = "MainPrdtFrame";
...
<div id="divName">
	...
	<tr>
		...
		<tr>
			...
			<tr>
				...
				<table cellpadding="0" cellspacing="0" width="1100" style="table-layout:fixed">
				<tr><td height="8"></td></tr>
				<tr>
					<td>					
						<!-- 소제목 -->
						<div class="title_depth3_sub">상품검색[<?=$title_name[$code]?>]</div>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<?php
										...
										$sql0.= $qry;
										$paging = new newPaging($sql0,10, 5);
										...
										if (ord($row->tinyimage) && file_exists($imagepath.$row->tinyimage)){
											echo "<a href=\"javascript:ProductInfo('".$row->productcode."','YES');\"><img src='".$imagepath.$row->tinyimage."' style=\"width:40px\" border=1 onMouseOver=\"ProductMouseOver('primage{$cnt}')\" onMouseOut=\"ProductMouseOut('primage{$cnt}');\"></a>";
										} else if (ord($row->tinyimage) && file_exists($Dir.$row->tinyimage)){
											echo "<a href=\"javascript:ProductInfo('".$row->productcode."','YES');\"><img src='".$Dir.$row->tinyimage."' style=\"width:40px\" border=1 onMouseOver=\"ProductMouseOver('primage{$cnt}')\" onMouseOut=\"ProductMouseOut('primage{$cnt}');\"></a>";
										} else {
	...
	<?php					
			...
			?>
								...
								<td valign=top>
									<div class="title_depth3_sub"><?=$title_name[$code]?> 진열 리스트</div>								
									<IFRAME name="MainPrdtFrame" src="home_banner.item.main.php" width=100% height=100% frameborder=0 align=TOP scrolling="no" marginheight="0" marginwidth="0"></IFRAME>	
								</td>
							</tr>
						</table>
	...
	<form name='formList' action="home_banner.item.main.php" method='post'>
