...
<?php
			...
			if($search_all != 'all'){
				...
				$sql = "SELECT b.minimage, a.id,a.name,a.reserve,a.display,a.subject,a.content,a.date,a.productcode,b.productname,b.tinyimage,b.selfcode,b.assembleuse, a.best_type, a.marks, a.type, a.num ";
