...
$qry_from .= "join (Select p.oc_no, pb.brandname, p.vender from tblorderproduct p left join tblvenderinfo v on p.vender = v.vender left join tblproductbrand pb on p.vender=pb.vender where p.oc_no > 0 and p.redelivery_type = 'Y' and p.op_step != '40' group by p.oc_no, p.vender, pb.brandname) b on toc.oc_no=b.oc_no ";
...
function OrderCheckRegoods() {
	...
	//return;
	if(confirm("반품수거 하시겠습니까?")) {
		document.exeform.mode.value="regoods";
		...
		<tr>
			...
			<tr>
				...
				<tr>
					...
					<FONT COLOR="#ffffff"><B>주문반품</B></FONT>
					</td>
					<td></td>
				</tr>
				</table>
			...
			<tr>
				...
				<tr>
					...
					<tr>
						<td style="padding-bottom:5"><img src="images/icon_boxdot.gif" border=0 align=absmiddle> <B>주문반품</B></td>
					</tr>
					<tr>
						<td style="padding-left:5;color:#7F7F7F"><img src="images/icon_dot02.gif" border=0> 입점사에서 등록한 상품만 반품관리 할 수 있습니다.</td>
					</tr>
					<tr>
...
?>
				...
				<tr>
					<td>
					<A HREF="javascript:OrderCheckRegoods()"><img src=images/btn_regoods.gif border=0 align=absmiddle style='padding-bottom:4px'></A>
					</td>
