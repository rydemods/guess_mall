...
function T_onProductcode(recordname, prname,prcode,primg){
	...
	if(upList){
		...
		if (limit > 1 || limit =='')
		{
			...
			appHtml+= "			<img src=\"/admin/images/btn_plus.gif\" border=\"0\" style=\"margin-bottom: 3px;\" />\n";
			appHtml+= "		</a>\n";
			appHtml+= "		<br>\n";
			appHtml+= "		<a name=\"pro_downChange\" style=\"cursor: hand;\">\n";
			appHtml+= "			<img src=\"/admin/images/btn_minus.gif\" border=\"0\" style=\"margin-top: 3px;\" />\n";
			appHtml+= "		</a>\n";
			appHtml+= "	</td>\n";
		}
		appHtml+= "	<td style='border:0px'>\n";
