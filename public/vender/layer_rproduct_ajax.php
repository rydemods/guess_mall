...
?>
		...
		<?} ?>
			...
			<!--판매가-->
			<td style="text-align:right; padding-right:10px">기본가 : <img src="/admin/images/won_icon.gif" border="0" style="margin-right:2px;">
				<span class="font_orange"><?=number_format($row->consumerprice)?></span><br>
			</td>
			<!--시중가-->
			<td style="text-align:right; padding-right:10px">
				기본가 : <img src="/admin/images/won_icon.gif" border="0" style="margin-right:2px;">
