...
$sql .= " ORDER BY lower(b.brandname) ASC";
		...
		<div class="pop-container">
			<div class="pop-conts">
				...
				<p class="ctxt mb20" style="font-size:15px; font-weight: 700;">상품 선택<br>
                    ...
                    상품명 검색 : <input type="text" name="s_prod_keyword" id="s_prod_keyword" value="" style="width: 250px;"/> <a href="javascript:T_productListSearch();"><img src="/admin/images/btn_search.gif" style="position: absolute; padding-left: 5px;"/></a>
                    </div>
				</p>
				<div id="productList">
				</div>
