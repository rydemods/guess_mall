...
$cnt = 0;
$sql = "SELECT productcode, substr(tag_style_no,1,2) tag_prodcd_f, substr(tag_style_no,1,9) tag_prodcd, colorcode FROM tblproduct WHERE maximage IS NULL AND join_yn != 'Y' ORDER BY date ASC "; // LIMIT 100
...
while($row = pmysql_fetch_array($result)) {
	...
	$remot_file_img_bb	= $remot_file_path2.'_B.JPG';
	if(remoteFileExist($remot_file_img_b) == 1 || remoteFileExist($remot_file_img_bb) == 1) {
	$ext	= (remoteFileExist($remot_file_img_b) == 1)?'.jpg':'.JPG';
	$remot_file_arr	 = array(
									'max' => array(
													'img' => $remot_file_path2.'_B'.$ext,
													'size' => '900X900'
												),
									'min' => array(
													'img' => $remot_file_path2.'_M'.$ext,
													'size' => '600X600'
												),
									'tiny' => array(
													'img' => $remot_file_path2.'_S'.$ext,
													'size' => '600X600'
												),
									'primg1' => array(
													'img' => $remot_file_path2.'_2'.$ext,
													'size' => '900X900'
												),
									'primg2' => array(
													'img' => $remot_file_path2.'_3'.$ext,
													'size' => '900X900'
												),
									'primg3' => array(
													'img' => $remot_file_path2.'_4'.$ext,
													'size' => '900X900'
												),
									'primg4' => array(
													'img' => $remot_file_path2.'_5'.$ext,
													'size' => '900X900'
												),
									'primg5' => array(
													'img' => $remot_file_path2.'_6'.$ext,
													'size' => '900X900'
												),
									'primg6' => array(
													'img' => $remot_file_path2.'_7'.$ext,
													'size' => '900X900'
												),
									'primg7' => array(
													'img' => $remot_file_path2.'_8'.$ext,
													'size' => '900X900'
												),
									'primg8' => array(
													'img' => $remot_file_path2.'_9'.$ext,
													'size' => '900X900'
												),
									'primg9' => array(
													'img' => $remot_file_path2.'_10'.$ext,
													'size' => '900X900'
												),
									'primg10' => array(
													'img' => $remot_file_path2.'_11'.$ext,
													'size' => '900X900'
												),
									'detail' => array(
		...
		$remot_file_img_bb	= $remot_file_path3.'_B.JPG';
		if(remoteFileExist($remot_file_img_b) == 1 || remoteFileExist($remot_file_img_bb) == 1) {
		$ext	= (remoteFileExist($remot_file_img_b) == 1)?'.jpg':'.JPG';
		$remot_file_arr	 = array(
										'max' => array(
														'img' => $remot_file_path3.'_B'.$ext,
														'size' => '900X900'
													),
										'min' => array(
														'img' => $remot_file_path3.'_M'.$ext,
														'size' => '600X600'
													),
										'tiny' => array(
														'img' => $remot_file_path3.'_S'.$ext,
														'size' => '600X600'
													),
										'primg1' => array(
														'img' => $remot_file_path3.'_2'.$ext,
														'size' => '900X900'
													),
										'primg2' => array(
														'img' => $remot_file_path3.'_3'.$ext,
														'size' => '900X900'
													),
										'primg3' => array(
														'img' => $remot_file_path3.'_4'.$ext,
														'size' => '900X900'
													),
										'primg4' => array(
														'img' => $remot_file_path3.'_5'.$ext,
														'size' => '900X900'
													),
										'primg5' => array(
														'img' => $remot_file_path3.'_6'.$ext,
														'size' => '900X900'
													),
										'primg6' => array(
														'img' => $remot_file_path3.'_7'.$ext,
														'size' => '900X900'
													),
										'primg7' => array(
														'img' => $remot_file_path3.'_8'.$ext,
														'size' => '900X900'
													),
										'primg8' => array(
														'img' => $remot_file_path3.'_9'.$ext,
														'size' => '900X900'
													),
										'primg9' => array(
														'img' => $remot_file_path3.'_10'.$ext,
														'size' => '900X900'
													),
										'primg10' => array(
														'img' => $remot_file_path3.'_11'.$ext,
														'size' => '900X900'
													),
										'detail' => array(
														'img' => $remot_file_path.'_02.jpg',
