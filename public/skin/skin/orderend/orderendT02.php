...
<?
	...
	while($row=pmysql_fetch_object($result)) {
		...
		$totprice+=$sumprice;
		echo "<tr ".($sumprice<0?"height=\"22\" bgcolor=\"#FFFBF1\"":"height=\"26\"").">\n";
...
?>
		...
		<tr>
			...
			<col width="100"></col>
			<tr>
				<td colspan="2" height="2" bgcolor="#FF7D04"></td>
			</tr>
			<tr height="30" bgcolor="#FFFBF1">
...
<?
	if(strstr("VCPM", $_ord->paymethod[0])) {
		...
		if(strstr("B", $_ord->paymethod[0])) echo "무통장 입금 : <font color=#0054A6>".$_ord->pay_data."</font> <br>\n(입금확인후 배송이 됩니다.)";
		else {
