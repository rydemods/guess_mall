...
$replace=array($one_start,$one_code_a,$one_code_b,$one_code_c,$one_code_d,$one_prlist,$one_primg,"\"javascript:OneshotBasketIn()\"",$one_end,$basket_msg,$originalbasket,$basket_order,$basket_shopping,$basket_clear,$royalvalue);
