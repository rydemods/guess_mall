...
<tr>
	...
	<tr>
		<td>
		<table border="0" cellpadding="0" cellspacing="8" width="100%" bgcolor="#F3F3F3">
		<tr>
			<td style="padding:10px;" bgcolor="#FFFFFF">
			<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td><IMG SRC="<?=$Dir?>images/member/idsearch_skin1_img01.gif" border="0"></td>
				...
				<td><A HREF="javascript:CheckForm()"><img src="<?=$Dir?>images/member/idsearch_skin1_pwbtn.gif" border="0"></a></td>
			</tr>
			</table>
			</td>
		</tr>
	...
	<tr>
		<td align="center"><A HREF="<?=$Dir.FrontDir?>login.php"><img src="<?=$Dir?>images/member/idsearch_skin1_loginbtn.gif" border="0"></a></td>
	</tr>
	</table>
	</td>
</tr>
