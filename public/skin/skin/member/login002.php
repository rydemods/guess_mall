		...
		<tr>
			...
			<tr>
				...
				<tr>
					...
					<table cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td><IMG SRC=[DIR]images/member/login_con_text0_skin1.gif border="0"></td>
					</tr>
					<tr>
						<td height="20"></td>
					</tr>
					...
					<tr>
						...
						<table cellpadding="0" cellspacing="0">
						<tr>
							<td><IMG SRC=[DIR]images/member/login_con_stabletop_skin1.gif border="0"></td>
						</tr>
						<tr>
							<td bgcolor="#F0EED7">
						...
						<tr>
							<td><IMG SRC=[DIR]images/member/login_con_stabledown_skin1.gif border="0"></td>
						</tr>
						</table>
						</td>
					</tr>
					...
					<tr>
						...
						<tr>
							...
							<td><A HREF=[NOLOGIN]><IMG SRC=[DIR]images/member/login_con_btn4_skin1.gif border="0"></A></td>
						</tr>
						</table>
						</td>
					</tr>
					...
					<tr>
						...
						<tr>
							...
							<tr>
								...
								<tr>
									<td><img src=[DIR]images/member/login_con_text5a_2_skin1.gif border="0" hspace="10"></td>
									<td>[ORDERCODE]</td>
								</tr>
								</table>
								</td>
								<td><a href=[ORDEROK]><IMG SRC=[DIR]images/member/login_con_btn2_skin1.gif border="0" hspace="10"></a></td>
							</tr>
							</table>
							</td>
						</tr>
