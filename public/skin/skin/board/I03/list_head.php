...
<tr>
	...
	<tr>
		<td><IMG SRC="<?=$imgdir?>/board_skin1_img1.gif" border="0"></td>
		<td width="100%" background="<?=$imgdir?>/board_skin1_imgbg.gif">
		...
		<td><IMG SRC="<?=$imgdir?>/board_skin1_img2.gif" border="0"></td>
	</tr>
	</table>
