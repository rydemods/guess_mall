		...
		<td colspan="<?=$table_colcnt?>">
			...
			<TR>
				...
				<tr>
					...
					<TD background="<?=$imgdir?>/board_skin1_t_bg1.gif"><?=$secret_img?> <B><?=$subject?></B></TD>
	...
	<tr>
		...
		<tr>
			...
			<TR>
				...
				<? if ($file_name_str1) { ?>
				<TR>
					<TD align="right" height="30" style="font-size:11px;"><font color="#FF6600">梅何颇老 : <?=$file_name1?></font></TD>
				</TR>
				<? } else if($strIp) { ?>
				<TR>
