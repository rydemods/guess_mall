...
<tr>
	...
	<TR>
		...
		<TD style="border-left:<?=$list_divider?> 1px solid;"><input type=text name="up_name" value="<?=$thisBoard[name]?>" size="13" maxlength="20" style="border-color:#C0E9D1;BACKGROUND-COLOR:#F4FBF7;width:160px" class="input"></TD>
		<TD align="center" style="border-left:<?=$list_divider?> 1px solid;"><font color="#333333">비밀번호</font></TD>
		<TD style="border-left:<?=$list_divider?> 1px solid;"><input type=password name="up_passwd" value="<?=$thisBoard[passwd]?>" size="13" maxlength="20" style="border-color:#C0E9D1;BACKGROUND-COLOR:#F4FBF7;width:160px" class="input"></TD>
	</TR>
	<TR>
		<TD height="1" colspan="4" bgcolor="<?=$list_divider?>"></TD>
	</TR>
	<TR>
		...
		<TD colspan="3" style="border-left:<?=$list_divider?> 1px solid;"><input type=text name="up_email" value="<?=$thisBoard[email]?>" size="49" maxlength="60" style="border-color:#C0E9D1;BACKGROUND-COLOR:#F4FBF7;width:240px" class="input"> <font color="#008C5C" style="font-size:11px;letter-spacing:-0.5pt;">* 답변을 받으실 E-mail을 입력하세요.</font></TD>
	</TR>
	<TR>
		<TD height="1" colspan="4" bgcolor="<?=$list_divider?>"></TD>
	</TR>
	<TR>
		...
		<TD colspan="3" style="border-left:<?=$list_divider?> 1px solid;"><input type=text name="up_subject" value="<?=$thisBoard[title]?>" size="70" maxlength="200" class="input" style="border-color:#C0E9D1;BACKGROUND-COLOR:#F4FBF7;width:100%"></TD>
	</TR>
	<TR>
		<TD height="1" colspan="4" bgcolor="<?=$list_divider?>"></TD>
	</TR>
	...
	<TR>
		...
		<TD colspan="3" style="padding-top:3px;border-left:<?=$list_divider?> 1px solid;"><input type=text name="up_filename" size="30" onfocus="this.blur();" style="width:75%;BACKGROUND-COLOR:#F4FBF7;border-color:#C0E9D1;" class="input"> <INPUT type=button value="파일첨부" style="BORDER:#008C5C 1px solid;CURSOR:hand;font-size:9pt;color:#FFFFFF;height:19px;background-color:#008C5C" onclick="FileUp();"><br><font color="#008C5C" style="font-size:11px;letter-spacing:-0.5pt;">* 최대 <b><?=($setup[max_filesize]/1024)?>KB</b>까지 업로드 가능합니다.</font>
