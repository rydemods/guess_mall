...
//	$ItemCode = "1270000000";
	...
	$ByPassValue["TargetURL"] = "http://" . $_SERVER['HTTP_HOST'] . "/paygate/E/charge_result.php";
	$ByPassValue["BackURL"] = "http://" . $_SERVER['HTTP_HOST'] . "/paygate/E/BackURL.php";
	$ByPassValue["IsUseCI"] = "N";
	$ByPassValue["CIURL"] = "http://" . $_SERVER['HTTP_HOST'] . "/paygate/E/images/ci.gif";
