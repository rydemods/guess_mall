...
/*
    $CPName = $_data->shopname;
    $EmailAddr = $_ShopInfo->getEmail?:"user@cp.co.kr";
*/
	...
	function GetCIMobileURL($IsUseCI,$CIURL) {

		/*
		 * Default Danal CI
		 */
		$URL = "https://ui.teledit.com/Danal/Teledit/FlexMobile/images/logo.png";
