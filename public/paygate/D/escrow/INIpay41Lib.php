...
/* == 디지털 문화 상품권 카드 번호와 잔액을 배열에 저장 (최대 6장) (SKT 상품권 공통으로 사용) == */				
		$this->m_dgcl_cardnum = array($dgcl_cardnum1,$dgcl_cardnum2,$dgcl_cardnum3,$dgcl_cardnum4,$dgcl_cardnum5,$dgcl_cardnum6);
		$this->m_dgcl_remain_price = array($dgcl_remain_price1,$dgcl_remain_price2,$dgcl_remain_price3,$dgcl_remain_price4,$dgcl_remain_price5,$dgcl_remain_price6);

/* == 디지털 문화 상품권 결제 실패시 에러메세지 (SKT 상품권 공통으로 사용) == */
		$this->m_dgcl_errmsg = array($dgcl_errmsg1,$dgcl_errmsg2,$dgcl_errmsg3,$dgcl_errmsg4,$dgcl_errmsg5,$dgcl_errmsg6);
