...
$sql  = "INSERT INTO tblboardcomment (board,parent,name,passwd,ip,writetime,comment, c_mem_id, is_secret ) VALUES ";
...
// 코멘트 갯수를 구해서 정리
$total=pmysql_fetch_array(pmysql_query("SELECT COUNT(*) FROM tblboardcomment WHERE board='{$board}' AND parent='{$num}'",get_db_conn()));
