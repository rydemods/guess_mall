...
$qry  = "SELECT * FROM tblboardcomment_re WHERE board='".$board."' AND num='".$c_num."' ";
...
if ($_POST["mode"] == "delete") {
	...
	$del_sql = "DELETE FROM tblboardcomment_re WHERE board='".$board."' AND num = '".$_POST["c_num"]."'";
...
<input type=hidden name=pagetype value="delete_comment_re">
